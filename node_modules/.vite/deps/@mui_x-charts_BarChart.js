...
} from "./chunk-ZQEDQF2K.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-BFL632LT.js";
import {
  warnOnce
} from "./chunk-GMHLTGKN.js";
import "./chunk-5PF763UE.js";
import {
  HTMLElementType,
  Popper_default,
  useLazyRef,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React90 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState7 = React90.useState, useEffect21 = React90.useEffect, useLayoutEffect = React90.useLayoutEffect, useDebugValue = React90.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React90 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore3 = shim.useSyncExternalStore, useRef16 = React90.useRef, useEffect21 = React90.useEffect, useMemo16 = React90.useMemo, useDebugValue = React90.useDebugValue;
      exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot2, getServerSnapshot2, selector, isEqual) {
...
// node_modules/@mui/x-charts/BarChart/BarChart.mjs
var React89 = __toESM(require_react(), 1);
var import_prop_types32 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/BarChart/BarPlot.mjs
...
function initialize(params) {
  ...
  const instance = {
    ...
    onMount: () => {
      ...
      return () => {
        var _a2;
        (_a2 = instance.dispose) == null ? void 0 : _a2.call(instance);
...
var selectorChartRawXAxis = (state) => {
  var _a2;
  return (_a2 = state.cartesianAxis) == null ? void 0 : _a2.x;
};
var selectorChartRawYAxis = (state) => {
  var _a2;
  return (_a2 = state.cartesianAxis) == null ? void 0 : _a2.y;
};
var selectorChartCartesianAxesGap = (state) => {
  var _a2;
  return ((_a2 = state.cartesianAxis) == null ? void 0 : _a2.axesGap) ?? 0;
};
...
function createScaleBand(seed) {
  let index2 = seed ? seed.index : new InternMap(void 0, keyof2);
  ...
  const scale = (d) => {
    ...
    const k2 = reverse2 ? n - 1 - i % n : i % n;
    return start + step * k2;
  };
  const rescale = () => {
    const n = domain.length;
    reverse2 = r1 < r0;
    const lo = reverse2 ? r1 : r0;
    const hi = reverse2 ? r0 : r1;
...
var defaultizeSeries = ({
  ...
  series.forEach((seriesData, seriesIndex) => {
    ...
    if (((_a2 = seriesGroups[seriesData.type]) == null ? void 0 : _a2.series[id]) !== void 0) {
...
var applySeriesProcessors = (defaultizedSeries, seriesConfig, dataset, isItemVisible) => {
  ...
  Object.keys(seriesConfig).forEach((type) => {
    ...
    if (group2 !== void 0) {
      processedSeries[type] = ((_b = (_a2 = seriesConfig[type]) == null ? void 0 : _a2.seriesProcessor) == null ? void 0 : _b.call(_a2, group2, dataset, isItemVisible)) ?? group2;
    }
  });
...
var applySeriesLayout = (processedSeries, seriesConfig, drawingArea) => {
  ...
  Object.keys(processedSeries).forEach((type) => {
    var _a2;
    const processor = (_a2 = seriesConfig[type]) == null ? void 0 : _a2.seriesLayout;
...
var serializeIdentifier = (seriesConfig, identifier) => {
  var _a2;
  const serializer = (_a2 = seriesConfig[identifier.type]) == null ? void 0 : _a2.identifierSerializer;
  if (!serializer) {
...
var cleanIdentifier = (seriesConfig, identifier) => {
  var _a2;
  const cleaner = (_a2 = seriesConfig[identifier.type]) == null ? void 0 : _a2.identifierCleaner;
  if (!cleaner) {
...
useChartSeries.getDefaultizedParams = ({
  ...
  return _extends({}, params, {
    series: ((_a2 = params.series) == null ? void 0 : _a2.length) ? params.series : EMPTY_ARRAY,
...
var useChartVisibilityManager = ({
  ...
  const hideItem = useEventCallback_default((identifier) => {
    ...
    (_a2 = params.onHiddenItemsChange) == null ? void 0 : _a2.call(params, values);
  });
  const showItem = useEventCallback_default((identifier) => {
    ...
    (_a2 = params.onHiddenItemsChange) == null ? void 0 : _a2.call(params, Array.from(newVisibilityMap.values()));
  });
...
var axisExtremumCallback = (chartType, axis, axisDirection, seriesConfig, axisIndex, formattedSeries, getFilters) => {
  ...
  const series = ((_a2 = formattedSeries[chartType]) == null ? void 0 : _a2.series) ?? {};
...
var getAxisDomainLimit = (axis, axisDirection, axisIndex, formattedSeries) => {
  ...
  if (axisDirection === "x") {
    for (const seriesId of ((_a2 = formattedSeries.line) == null ? void 0 : _a2.seriesOrder) ?? []) {
  ...
  axes == null ? void 0 : axes.forEach((eachAxis, axisIndex) => {
    ...
    if (isBandScaleConfig(axis) || isPointScaleConfig(axis)) {
      ...
      if (axis.ordinalTimeTicks !== void 0) {
        domains[axis.id].tickNumber = getTickNumber(axis, [(_a2 = axis.data) == null ? void 0 : _a2.find((d) => d !== null), (_b = axis.data) == null ? void 0 : _b.findLast((d) => d !== null)], defaultTickNumber);
      }
      return;
    }
...
function selectXAxisSize(axes, axesGap, position, autoSizes) {
  ...
  for (const axis of axes ?? []) {
    ...
    axesSize += axisSize + (((_a2 = axis.zoom) == null ? void 0 : _a2.slider.enabled) ? axis.zoom.slider.size : 0);
    nbOfAxes += 1;
  }
...
var useChartDimensions = ({
  ...
  const stateRef = React5.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const [innerWidth, setInnerWidth] = React5.useState(0);
  const [innerHeight, setInnerHeight] = React5.useState(0);
  const computeSize = React5.useCallback(() => {
  ...
  const isXInside = React5.useCallback((x2) => x2 >= drawingArea.left - 1 && x2 <= drawingArea.left + drawingArea.width, [drawingArea.left, drawingArea.width]);
  const isYInside = React5.useCallback((y2) => y2 >= drawingArea.top - 1 && y2 <= drawingArea.top + drawingArea.height, [drawingArea.height, drawingArea.top]);
  const isPointInside = React5.useCallback((x2, y2, targetElement) => {
...
var useChartElementRef = () => {
  const chartsLayerContainerRef = React6.useRef(null);
  const chartRootRef = React6.useRef(null);
  return {
    instance: {
      chartsLayerContainerRef,
      chartRootRef
...
// node_modules/@mui/x-charts/internals/plugins/corePlugins/useChartExperimentalFeature/useChartExperimentalFeature.selectors.mjs
var selectorChartExperimentalFeaturesState = (state, featureName) => {
  var _a2;
  return (_a2 = state.experimentalFeatures) == null ? void 0 : _a2[featureName];
};
  ...
  areKeysPressed(keys) {
    ...
    return keys.every((key) => {
      if (key === "ControlOrMeta") {
        return parts_exports.os.apple ? this.pressedKeys.has("Meta") : this.pressedKeys.has("Control");
      }
...
var PanGesture = class _PanGesture extends PointerGesture {
        ...
        case "forceCancel":
          if (this.isActive && this.state.movementThresholdReached) {
            ...
            if (!this.isWithinPointerCount(remainingPointers, event.pointerType)) {
              ...
              this.state.lastCentroid = newCentroid;
              const removedPointerId = (_a2 = relevantPointers.find((p) => p.type === "pointerup" || p.type === "pointercancel")) == null ? void 0 : _a2.pointerId;
  ...
  emitPanEvent(element, phase, pointers, event, currentCentroid) {
    ...
    const deltaX = ((_a2 = this.state.lastDeltas) == null ? void 0 : _a2.x) ?? 0;
...
var useChartInteractionListener = ({
  ...
  const gestureManagerRef = React8.useRef(null);
  React8.useEffect(() => {
  ...
  const addInteractionListener = React8.useCallback((interaction, callback, options) => {
    const svg = chartsLayerContainerRef.current;
  ...
  const updateZoomInteractionListeners = React8.useCallback((interaction, options) => {
    const svg = chartsLayerContainerRef.current;
    const gestureManager = gestureManagerRef.current;
  ...
  const registerGestures = React8.useCallback((gestures) => {
    const svg = chartsLayerContainerRef.current;
    const gestureManager = gestureManagerRef.current;
    if (!gestureManager || !svg) {
      return () => {
...
function useChartApiInitialization(inputApiRef) {
  const fallbackPublicApiRef = React9.useRef({});
  if (inputApiRef) {
...
var ChartsContext = React10.createContext(null);
...
var getEffectiveZoomReverse = (axisDirection, scaleType, reverse2) => {
  const resolvedReverse = reverse2 ?? false;
...
var defaultizeZoom = (zoom, axisId, axisDirection, reverse2) => {
  ...
  return _extends({
    ...
    slider: _extends({}, defaultZoomOptions.slider, {
      size: ((_a2 = zoom.slider) == null ? void 0 : _a2.preview) ?? defaultZoomOptions.slider.preview ? DEFAULT_ZOOM_SLIDER_PREVIEW_SIZE : DEFAULT_ZOOM_SLIDER_SIZE
    }, zoom.slider)
  });
};
...
function defaultizeXAxis(inAxes, dataset, axesGap) {
  ...
  const parsedAxes = inputAxes.map((axisConfig, index2) => {
    ...
    if (position !== "none") {
      ...
      if ((_a2 = sharedConfig.zoom) == null ? void 0 : _a2.slider.enabled) {
...
function getSequentialColorScale(config) {
  if (config.type === "piecewise") {
    return threshold(config.thresholds, config.colors).unknown(config.unknownColor ?? null);
  }
...
var createGetAxisFilters = (filters) => ({
  ...
  return (value, dataIndex) => {
    ...
    if (!axisId || isDefaultAxis) {
      return ((_b = (_a2 = Object.values(filters ?? {}))[0]) == null ? void 0 : _b.call(_a2, value, dataIndex)) ?? true;
    }
...
var createZoomLookup = (axisDirection) => (axes = []) => axes.reduce((acc, v) => {
  ...
  const defaultizedZoom = defaultizeZoom(zoom, axisId, axisDirection, getEffectiveZoomReverse(axisDirection, scaleType, reverse2));
  if (defaultizedZoom) {
...
function getNormalizedAxisScale(axis, domain) {
  ...
  if (isBandScaleConfig(axis)) {
    ...
    return getCachedOrdinalScale(domain, `band:${categoryGapRatio}`, () => scaleBand(domain, range2).paddingInner(categoryGapRatio).paddingOuter(categoryGapRatio / 2));
  }
  if (isPointScaleConfig(axis)) {
    return getCachedOrdinalScale(domain, "point", () => scalePoint(domain, range2));
  }
...
// node_modules/@mui/x-charts/internals/sizeScale.mjs
...
function getSequentialSizeScale(config) {
  if (config.type === "piecewise") {
    return threshold(config.thresholds, config.sizes);
  }
  if (isFunctionInterpolator(config)) {
    return sequential([config.min ?? 0, config.max ?? 100], config.size);
  }
  const interpolator = config.interpolator ?? "sqrt";
  switch (interpolator) {
    case "log":
      return sequentialLog([config.min ?? 0, config.max ?? 100], getClampedSize(config.size));
    case "linear":
      return sequential([config.min ?? 0, config.max ?? 100], getClampedSize(config.size));
    case "sqrt":
    default:
      return sequentialSqrt([config.min ?? 0, config.max ?? 100], getClampedSize(config.size));
  }
}
function getOrdinalSizeScale(config) {
  if (config.values) {
    return ordinal(config.values, config.sizes).unknown(config.unknownSize ?? null);
  }
  return ordinal(config.sizes.map((_, index2) => index2), config.sizes).unknown(config.unknownSize ?? null);
}
...
// node_modules/@mui/x-charts/ScatterChart/seriesConfig/getMarkerSize.mjs
var getMarkerSize = (series, sizeZAxis) => {
  const sizeScale = sizeZAxis == null ? void 0 : sizeZAxis.sizeScale;
  if (!sizeScale) {
    return () => series.markerSize;
  }
  return (dataIndex) => {
    var _a2;
    if (((_a2 = sizeZAxis == null ? void 0 : sizeZAxis.data) == null ? void 0 : _a2[dataIndex]) !== void 0) {
...
var getMarkerSize_default = getMarkerSize;
...
var selectorChartSeriesFlatbushMap = createSelectorMemoized(selectorChartSeriesProcessed, selectorChartNormalizedXScales, selectorChartNormalizedYScales, selectorChartDefaultXAxisId, selectorChartDefaultYAxisId, selectorChartZAxis, function selectChartSeriesFlatbushMap(allSeries, xAxesScaleMap, yAxesScaleMap, defaultXAxisId, defaultYAxisId, zAxisState) {
  ...
  const zAxes = (zAxisState == null ? void 0 : zAxisState.axis) ?? {};
  const zAxisIds = (zAxisState == null ? void 0 : zAxisState.axisIds) ?? [];
  validSeries.seriesOrder.forEach((seriesId) => {
    ...
    const getItemRadius = isFixedSize ? series.markerSize ?? 0 : getMarkerSize_default(series, sizeAxis);
...
var createSelectAxisHighlight = (direction) => (item, axis, series) => {
  ...
  const seriesConfig = (_a2 = series[item.type]) == null ? void 0 : _a2.series[item.seriesId];
  if (!seriesConfig) {
    return void 0;
  }
...
var selectorBrushStartX = createSelector2(selectorBrush, (brush) => {
  var _a2;
  return ((_a2 = brush == null ? void 0 : brush.start) == null ? void 0 : _a2.x) ?? null;
});
var selectorBrushStartY = createSelector2(selectorBrush, (brush) => {
  var _a2;
  return ((_a2 = brush == null ? void 0 : brush.start) == null ? void 0 : _a2.y) ?? null;
});
var selectorBrushCurrentX = createSelector2(selectorBrush, (brush) => {
  var _a2;
  return ((_a2 = brush == null ? void 0 : brush.current) == null ? void 0 : _a2.x) ?? null;
});
var selectorBrushCurrentY = createSelector2(selectorBrush, (brush) => {
  var _a2;
  return ((_a2 = brush == null ? void 0 : brush.current) == null ? void 0 : _a2.y) ?? null;
});
...
var useChartBrush = ({
  ...
  React14.useEffect(() => {
    ...
    const handleBrushStart = (event) => {
      var _a2;
      if ((_a2 = event.detail.target) == null ? void 0 : _a2.closest("[data-charts-zoom-slider]")) {
        return;
      }
...
useChartBrush.getDefaultizedParams = ({
  ...
  return _extends({}, params, {
    brushConfig: {
      enabled: ((_a2 = params == null ? void 0 : params.brushConfig) == null ? void 0 : _a2.enabled) ?? false,
...
var selectAxisHighlightWithValue = (computedIndex, computedValue, axis, controlledAxisItems, keyboardAxisItem, lastInteractionUpdate, isBrushSelectionActive) => {
  ...
  if (controlledAxisItems !== void 0) {
    return controlledAxisItems.map((item) => {
      ...
      return _extends({}, item, {
        value: (_b2 = (_a3 = axis.axis[item.axisId]) == null ? void 0 : _a3.data) == null ? void 0 : _b2[item.dataIndex]
      });
    }).filter(({
      value
    }) => value !== void 0);
  ...
  const keyboardValue = keyboardAxisItem != null && ((_b = (_a2 = axis.axis[keyboardAxisItem.axisId]) == null ? void 0 : _a2.data) == null ? void 0 : _b[keyboardAxisItem.dataIndex]);
...
function getBandIndex(bandAxis, stackConfig, coordinate) {
  ...
  const bandValue = (_a2 = bandAxis.data) == null ? void 0 : _a2[dataIndex];
  if (bandValue == null) {
    return -1;
  }
...
function getCoordinatesFromAxis(identifier, axes) {
  ...
  const value = (_a2 = axis.data) == null ? void 0 : _a2[identifier.dataIndex];
  if (value == null) {
    return null;
  }
...
// node_modules/@mui/x-charts/internals/plugins/featurePlugins/useChartCartesianAxis/sampling.selectors.mjs
var EMPTY_PYRAMIDS = {};
var EMPTY_BUCKET_SIZES = /* @__PURE__ */ new Map();
...
var selectorChartSamplingState = (state) => state.sampling;
var selectorChartSamplingPyramids = createSelectorMemoized(selectorChartSamplingState, selectorChartSeriesProcessed, selectorChartSeriesConfig, function selectorChartSamplingPyramids2(samplingState, processedSeries, seriesConfig) {
  if (!(samplingState == null ? void 0 : samplingState.enabled)) {
  ...
  Object.keys(processedSeries).forEach((seriesType) => {
    ...
    const sampler = (_a2 = seriesConfig[seriesType]) == null ? void 0 : _a2.sampler;
...
var selectorChartHighlightBucketSize = createSelectorMemoized(selectorChartSamplingState, selectorChartZoomMap, selectorChartXAxis, selectorChartYAxis, selectorChartDrawingArea, selectorChartZoomOptionsLookup, selectorChartSeriesConfig, function selectorChartHighlightBucketSize2(samplingState, zoomMap, xAxis, yAxis, drawingArea, zoomOptions, seriesConfig) {
  var _a2, _b, _c, _d;
  if (!(samplingState == null ? void 0 : samplingState.enabled)) {
    return EMPTY_BUCKET_SIZES;
  }
  const bucketSizeAt = ((_b = (_a2 = seriesConfig.bar) == null ? void 0 : _a2.sampler) == null ? void 0 : _b.bucketSizeAt) ?? ((_d = (_c = seriesConfig.line) == null ? void 0 : _c.sampler) == null ? void 0 : _d.bucketSizeAt);
  if (!bucketSizeAt) {
    return EMPTY_BUCKET_SIZES;
  }
  const bucketSizes = /* @__PURE__ */ new Map();
  [[xAxis, drawingArea.width], [yAxis, drawingArea.height]].forEach(([axes, availableSize]) => {
    axes.axisIds.forEach((axisId) => {
      ...
      const zoom = (zoomMap == null ? void 0 : zoomMap.get(axisId)) ?? getFullRangeZoom(axisId);
      const minSpan = ((_a3 = zoomOptions[axisId]) == null ? void 0 : _a3.minSpan) ?? 0;
      if (data) {
...
var useChartTooltip = ({
  ...
  const removeTooltipItem = useEventCallback_default(function removeTooltipItem2(itemToRemove) {
    ...
    if (!itemToRemove || instance.serializeIdentifier(prevItem) === instance.serializeIdentifier(instance.identifierWithType(itemToRemove, "seriesItem"))) {
      (_a2 = params.onTooltipItemChange) == null ? void 0 : _a2.call(params, null);
  ...
  const setTooltipItem = useEventCallback_default(function setTooltipItem2(newItem) {
    ...
    if (!fastObjectShallowCompare(store.state.tooltip.item, newItem)) {
      (_a2 = params.onTooltipItemChange) == null ? void 0 : _a2.call(params, newItem);
      if (!store.state.tooltip.itemIsControlled) {
        store.set("tooltip", _extends({}, store.state.tooltip, {
          item: newItem
        }));
...
var useChartKeyboardNavigation = ({
  ...
  React15.useEffect(() => {
    ...
    function keyboardHandler(event) {
      ...
      const calculateFocusedItem = (_b = (_a2 = seriesConfig[seriesType]) == null ? void 0 : _a2.keyboardFocusHandler) == null ? void 0 : _b.call(_a2, event);
...
var useChartHighlight = ({
  ...
  useEnhancedEffect_default(() => {
    if (params.highlightedItem === void 0) {
      return;
    }
  ...
  const clearHighlight = useEventCallback_default(() => {
    var _a2;
    (_a2 = params.onHighlightChange) == null ? void 0 : _a2.call(params, null);
  ...
  const setHighlight = useEventCallback_default((newItem) => {
    ...
    (_a2 = params.onHighlightChange) == null ? void 0 : _a2.call(params, cleanedIdentifier);
...
var useChartsContext = () => {
  const context = React17.useContext(ChartsContext);
  if (context == null) {
...
var generateSvg2radius = (center) => (x2, y2) => Math.sqrt((x2 - center.cx) ** 2 + (center.cy - y2) ** 2);
...
var useChartPolarAxis = ({
  ...
  const svg2rotation = React18.useMemo(() => generateSvg2rotation({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const svg2polar = React18.useMemo(() => generateSvg2polar({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const polar2svg = React18.useMemo(() => generatePolar2svg({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const usedRotationAxisId = rotationAxisIds[0];
  const usedRadiusAxisId = radiusAxisIds[0];
  const mousePosition = React18.useRef({
    isInChart: false
  });
  const hasInteractionPlugin = checkHasInteractionPlugin(instance);
  React18.useEffect(() => {
  ...
  React18.useEffect(() => {
    ...
    const axisClickHandler = instance.addInteractionListener("tap", (event) => {
      ...
      Object.keys(processedSeries).filter(isPolarSeriesType).forEach((seriesType) => {
        var _a2;
        (_a2 = processedSeries[seriesType]) == null ? void 0 : _a2.seriesOrder.forEach((seriesId) => {
...
var selectorChartsInteractionRotationAxisValue = createSelector2(selectorChartRotationAxis, selectorChartsInteractionRotationAxisIndex, optionalGetAxisId, (rotationAxis, rotationIndex, id) => {
  ...
  const data = (_a2 = rotationAxis.axis[id]) == null ? void 0 : _a2.data;
  if (!data) {
    return null;
  }
...
var selectorChartsInteractionRotationAxisValues = createSelector2(selectorChartRotationAxis, selectorChartsInteractionRotationAxisIndexes, optionalGetAxisIds, (rotationAxis, rotationIndexes, ids) => {
  ...
  return ids.map((id, axisIndex) => {
    ...
    return (_a2 = rotationAxis.axis[id].data) == null ? void 0 : _a2[rotationIndex];
  });
});
...
var selectorChartsInteractionRadiusAxisValue = createSelector2(selectorChartRadiusAxis, selectorChartsInteractionRadiusAxisIndex, optionalGetAxisId, (radiusAxis, radiusIndex, id) => {
  ...
  const data = (_a2 = radiusAxis.axis[id]) == null ? void 0 : _a2.data;
  if (!data) {
    return null;
  }
...
var selectorChartsInteractionRadiusAxisValues = createSelector2(selectorChartRadiusAxis, selectorChartsInteractionRadiusAxisIndexes, optionalGetAxisIds, (radiusAxis, radiusIndexes, ids) => {
  ...
  return ids.map((id, axisIndex) => {
    ...
    return (_a2 = radiusAxis.axis[id].data) == null ? void 0 : _a2[radiusIndex];
  });
});
...
var selectorSeriesOfType = createSelectorMemoized(selectorChartSeriesProcessed, (processedSeries, seriesType, ids) => {
  ...
  if (ids === void 0) {
    return ((_b = (_a2 = processedSeries[seriesType]) == null ? void 0 : _a2.seriesOrder) == null ? void 0 : _b.map((seriesId) => {
      var _a3;
      return (_a3 = processedSeries[seriesType]) == null ? void 0 : _a3.series[seriesId];
    })) ?? [];
  }
...
// node_modules/@mui/x-charts/hooks/useBarSeries.mjs
...
var selectorChartsHighlightScopePerSeriesId = createSelectorMemoized(selectorChartSeriesProcessed, (processedSeries) => {
  ...
  Object.keys(processedSeries).forEach((seriesType) => {
    ...
    (_a2 = seriesData == null ? void 0 : seriesData.seriesOrder) == null ? void 0 : _a2.forEach((seriesId) => {
      var _a3;
      ...
      if ((seriesItem == null ? void 0 : seriesItem.highlightScope) !== void 0) {
        (_a3 = map4[seriesType]) == null ? void 0 : _a3.set(seriesId, seriesItem.highlightScope);
      }
    });
  });
  return map4;
...
var selectorChartsHighlightScope = createSelector2(selectorChartsHighlightScopePerSeriesId, selectorChartsHighlightedItem, function selectorChartsHighlightScope2(seriesIdToHighlightScope, highlightedItem) {
  ...
  const highlightScope = (_a2 = seriesIdToHighlightScope[highlightedItem.type]) == null ? void 0 : _a2.get(highlightedItem.seriesId);
...
function useChartGradientIdBuilder() {
  ...
  return React19.useCallback((axisId) => `${chartId}-gradient-${axisId}`, [chartId]);
}
function useChartGradientIdObjectBoundBuilder() {
  const chartId = useChartId2();
  return React19.useCallback((axisId) => `${chartId}-gradient-${axisId}-object-bound`, [chartId]);
}
...
var { cbrt, sqrt: sqrt2, PI: π } = Math;
var x2t = (x2, a2, b, c2, d) => {
  const q = a2 + b * x2;
  const s2 = q ** 2 + c2;
  if (s2 > 0) {
    const root = sqrt2(s2);
  ...
  const l = cbrt(sqrt2(q * q - s2));
  const angle = q ? Math.atan(sqrt2(-s2) / q) : -π / 2;
  let φ;
  if (b < 0) {
    φ = (q > 0 ? 2 * π : π) - angle;
  } else if (d < 0) {
...
function bezier(mX1, mY1, mX2, mY2) {
  ...
  const b2 = b * b;
  const d = b / a2;
  const e = 3 * b * c2 / a22 - b2 * b / (a22 * a2);
  const w1 = 2 * c2 / a2 - b2 / a22;
  const w = w1 * w1 * w1;
  const o = 3 / a2;
  ...
  return function BezierEasing(x2) {
    ...
    return Y(X2T(x2, e, o, w, d), ay, by, cy);
  };
}
...
var ANIMATION_TIMING_FUNCTION_JS = bezier(0.66, 0, 0.34, 1);
...
function useAnimateInternal(props, {
  ...
  const lastInterpolatedPropsRef = React20.useRef(initialProps);
  const transitionRef = React20.useRef(null);
  const elementRef = React20.useRef(null);
  const lastPropsRef = React20.useRef(props);
  useEnhancedEffect_default(() => {
  ...
  useEnhancedEffect_default(() => {
    var _a2;
    if (skip) {
      (_a2 = transitionRef.current) == null ? void 0 : _a2.finish();
      transitionRef.current = null;
      elementRef.current = null;
      lastInterpolatedPropsRef.current = props;
    }
  }, [props, skip]);
  const animate = React20.useCallback((element) => {
  ...
  const setRef = React20.useCallback((element) => {
    var _a2, _b, _c, _d;
    if (element === null) {
      (_a2 = transitionRef.current) == null ? void 0 : _a2.stop();
      return;
    }
...
// node_modules/@mui/x-charts/hooks/animation/useAnimateBar.mjs
...
// node_modules/@mui/x-charts/hooks/animation/useAnimateBarLabel.mjs
...
var ChartsLocalizationContext = React21.createContext(null);
...
function ChartsLocalizationProvider(inProps) {
  ...
  } = React21.useContext(ChartsLocalizationContext) ?? {
    localeText: void 0
  };
  ...
  const localeText = React21.useMemo(() => _extends({}, DEFAULT_LOCALE, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
...
var useChartsLocalization = () => {
  const localization = React22.useContext(ChartsLocalizationContext);
...
// node_modules/@mui/x-charts/ChartsXAxis/utilities.mjs
...
// node_modules/@mui/x-charts/internals/isInfinity.mjs
  ...
  for (let i = 0; i < ticks2.length; i += 1) {
    ...
    if (isInside(offset)) {
      ...
      visibleTicks.push({
        ...
        labelOffset: tickLabelPlacement === "middle" ? scale(ticks2[i - 1] ?? 0) - (offset + scale(ticks2[i - 1] ?? 0)) / 2 : 0
      });
    }
  }
  return visibleTicks;
...
function useTicks(options) {
  ...
  return React23.useMemo(() => getTicks({
    scale,
    tickNumber,
    tickPlacement,
    tickInterval,
...
// node_modules/@mui/x-charts/BarChart/BarLabel/BarLabelPlot.mjs
var React26 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/BarChart/BarLabel/BarLabelItem.mjs
var React25 = __toESM(require_react(), 1);
var import_prop_types3 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/BarChart/barClasses.mjs
function getBarUtilityClass(slot) {
  return generateUtilityClass("MuiBarChart", slot);
}
var barClasses = generateUtilityClasses("MuiBarChart", ["root", "series", "seriesLabels", "element", "label", "labelAnimate"]);
var useUtilityClasses2 = (options) => {
  const {
    skipAnimation,
    classes
  } = options ?? {};
...
// node_modules/@mui/x-charts/BarChart/BarLabel/getBarLabel.mjs
...
// node_modules/@mui/x-charts/BarChart/BarLabel/BarLabel.mjs
var React24 = __toESM(require_react(), 1);
var import_prop_types2 = __toESM(require_prop_types(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var _excluded3 = ["seriesId", "dataIndex", "color", "isFaded", "isHighlighted", "classes", "skipAnimation", "layout", "xOrigin", "yOrigin", "placement", "hidden"];
var BarLabelComponent = styled_default("text", {
  ...
  var _a2, _b, _c, _d;
  return _extends({}, (_a2 = theme == null ? void 0 : theme.typography) == null ? void 0 : _a2.body2, {
    stroke: "none",
...
function BarLabel(inProps) {
  ...
  return (0, import_jsx_runtime3.jsx)(BarLabelComponent, _extends({
    textAnchor,
    dominantBaseline,
...
function getDominantBaseline({
  ...
  if (placement === "outside") {
    ...
    return y2 < yOrigin ? "auto" : "hanging";
  }
  return "central";
}
true ? BarLabel.propTypes = {
  ...
  seriesId: import_prop_types2.default.string.isRequired,
...
var _excluded4 = ["seriesId", "classes", "color", "dataIndex", "barLabel", "slots", "slotProps", "xOrigin", "yOrigin", "x", "y", "width", "height", "value", "skipAnimation", "layout", "barLabelPlacement", "hidden"];
...
// node_modules/@mui/x-charts/internals/plugins/featurePlugins/useChartCartesianAxis/useInternalIsZoomInteracting.mjs
...
// node_modules/@mui/x-charts/BarChart/useBarPlotData.mjs
...
// node_modules/@mui/x-charts/internals/resolveColorProcessor.mjs
function resolveColorProcessor(params) {
  ...
  if (valueColorScale) {
    return (dataIndex) => {
      ...
      const value = series.data[dataIndex];
      const color2 = valueColorScale(value);
  ...
  if (categoryColorScale && categoryValues) {
    return (dataIndex) => {
      ...
      const color2 = categoryColorScale(value);
      if (typeof color2 !== "string") {
...
var getColor = (series, xAxis, yAxis) => {
  ...
  return resolveColorProcessor({
    series,
    valueColorScale: verticalLayout ? yAxis == null ? void 0 : yAxis.colorScale : xAxis == null ? void 0 : xAxis.colorScale,
    categoryColorScale: verticalLayout ? xAxis == null ? void 0 : xAxis.colorScale : yAxis == null ? void 0 : yAxis.colorScale,
    categoryValues: verticalLayout ? xAxis == null ? void 0 : xAxis.data : yAxis == null ? void 0 : yAxis.data
  });
};
var getColor_default = getColor;

// node_modules/@mui/x-charts/BarChart/checkBarChartScaleErrors.mjs
...
function checkBarChartScaleErrors(verticalLayout, seriesId, seriesDataLength, xAxisId, xAxis, yAxisId, yAxis) {
  ...
  if (discreteAxisConfig.scaleType !== "band") {
    throw new Error(true ? `MUI X Charts: ${getAxisMessage(discreteAxisDirection, discreteAxisId)} should be of type "band" to display the bar series of id "${seriesId}". Bar charts require a band scale for the category axis to properly position and size the bars. Set the scaleType to "band" for this axis.` : formatErrorMessage(1, getAxisMessage(discreteAxisDirection, discreteAxisId), seriesId));
  }
  if (discreteAxisConfig.data === void 0) {
    throw new Error(true ? `MUI X Charts: ${getAxisMessage(discreteAxisDirection, discreteAxisId)} should have a data property. The axis needs data to define the categories for the bar chart. Provide a data array to the axis configuration.` : formatErrorMessage(2, getAxisMessage(discreteAxisDirection, discreteAxisId)));
  }
  if (continuousAxisConfig.scaleType === "band" || continuousAxisConfig.scaleType === "point") {
    throw new Error(true ? `MUI X Charts: ${getAxisMessage(continuousAxisDirection, continuousAxisId)} should be a continuous type to display the bar series of id "${seriesId}". Bar charts require a continuous scale (like "linear" or "log") for the value axis. Change the scaleType to a continuous type such as "linear".` : formatErrorMessage(3, getAxisMessage(continuousAxisDirection, continuousAxisId), seriesId));
  }
  if (true) {
...
function createGetBucketBarDimensions(params) {
  ...
  return function getBucketBarDimensions(startIndex, endIndex, min3, max3, groupIndex) {
    ...
    const barOffset = groupIndex * (barWidth + offset);
    const valueCoordinates = [valueScale(min3), valueScale(max3)];
    const [minValueCoord, maxValueCoord] = findMinMax(valueCoordinates).map((v) => Math.round(v));
  ...
  const data = stackingGroups.flatMap(({
    ...
    return seriesIds.map((seriesId) => {
      ...
      const registerResult = (result, dataIndex) => {
        ...
        const sign2 = (reverse2 ? -1 : 1) * Math.sign(result.value ?? 0);
        if (sign2 > 0) {
          if (lastPositive) {
        ...
        mask.hasNegative = mask.hasNegative || (reverse2 ? value > 0 : value < 0);
        mask.hasPositive = mask.hasPositive || (reverse2 ? value < 0 : value > 0);
      ...
      const zoom = (zoomMap == null ? void 0 : zoomMap.get(baseAxisId)) ?? (pyramid ? getFullRangeZoom(baseAxisId) : void 0);
      const availableSize = verticalLayout ? drawingArea.width : drawingArea.height;
      const minSpan = ((_a2 = zoomOptions == null ? void 0 : zoomOptions[baseAxisId]) == null ? void 0 : _a2.minSpan) ?? 0;
      const sampledBuckets = pyramid && zoom && (sampler == null ? void 0 : sampler.sample) ? sampler.sample({
        built: pyramid,
        zoom,
        availableSize,
        minSpan
      ...
      if (sampledBuckets) {
        ...
        for (const {
          ...
          let low = Infinity;
          let high = -Infinity;
          for (let k2 = 0; k2 < indices.length; k2 += 1) {
            const point6 = stacked[indices[k2]];
            low = Math.min(low, point6[0], point6[1]);
            high = Math.max(high, point6[0], point6[1]);
          }
        ...
        if (dataLength > 1) {
          ...
          const slope = baseScale(baseData[1]) - p0;
          if (slope !== 0) {
...
// node_modules/@mui/x-charts/BarChart/IndividualBarPlot.mjs
var React32 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/BarChart/BarElement.mjs
var React29 = __toESM(require_react(), 1);
var import_prop_types4 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/BarChart/AnimatedBarElement.mjs
var React28 = __toESM(require_react(), 1);
var import_jsx_runtime6 = __toESM(require_jsx_runtime(), 1);
var _excluded6 = ["ownerState", "skipAnimation", "seriesId", "dataIndex", "xOrigin", "yOrigin"];
function AnimatedBarElement(props) {
  const {
    ownerState
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded6);
  const animatedProps = useAnimateBar(props);
  return (0, import_jsx_runtime6.jsx)("rect", _extends({}, other, {
...
// node_modules/@mui/x-charts/hooks/useIsItemFocused.mjs
...
var _excluded7 = ["seriesId", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick", "skipAnimation", "layout", "x", "xOrigin", "y", "yOrigin", "width", "height", "hidden"];
function BarElement(props) {
  ...
  const itemIdentifier = React29.useMemo(() => ({
    type: "bar",
    seriesId,
    dataIndex
  }), [seriesId, dataIndex]);
...
true ? BarElement.propTypes = {
  ...
  layout: import_prop_types4.default.oneOf(["horizontal", "vertical"]).isRequired,
  seriesId: import_prop_types4.default.string.isRequired,
  skipAnimation: import_prop_types4.default.bool.isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   */
...
// node_modules/@mui/x-charts/BarChart/BarClipPath.mjs
...
function generateClipPath(hasNegative, hasPositive, layout, x2, y2, width, height, xOrigin, yOrigin, borderRadius) {
  if (layout === "vertical") {
    if (hasPositive && hasNegative) {
      const bR2 = Math.min(borderRadius, width / 2, height / 2);
      return `M${x2},${y2 + height / 2} v${-(height / 2 - bR2)} a${bR2},${bR2} 0 0 1 ${bR2},${-bR2} h${width - bR2 * 2} a${bR2},${bR2} 0 0 1 ${bR2},${bR2} v${height - 2 * bR2} a${bR2},${bR2} 0 0 1 ${-bR2},${bR2} h${-(width - bR2 * 2)} a${bR2},${bR2} 0 0 1 ${-bR2},${-bR2} v${-(height / 2 - bR2)}`;
    }
    const bR = Math.min(borderRadius, width / 2);
    if (hasPositive) {
      return `M${x2},${Math.max(yOrigin, y2 + bR)} v${Math.min(0, -(yOrigin - y2 - bR))} a${bR},${bR} 0 0 1 ${bR},${-bR} h${width - bR * 2} a${bR},${bR} 0 0 1 ${bR},${bR} v${Math.max(0, yOrigin - y2 - bR)} Z`;
    }
    if (hasNegative) {
      return `M${x2},${Math.min(yOrigin, y2 + height - bR)} v${Math.max(0, height - bR)} a${bR},${bR} 0 0 0 ${bR},${bR} h${width - bR * 2} a${bR},${bR} 0 0 0 ${bR},${-bR} v${-Math.max(0, height - bR)} Z`;
    }
  }
  if (layout === "horizontal") {
    if (hasPositive && hasNegative) {
      const bR2 = Math.min(borderRadius, width / 2, height / 2);
      return `M${x2 + width / 2},${y2} h${width / 2 - bR2} a${bR2},${bR2} 0 0 1 ${bR2},${bR2} v${height - bR2 * 2} a${bR2},${bR2} 0 0 1 ${-bR2},${bR2} h${-(width - 2 * bR2)} a${bR2},${bR2} 0 0 1 ${-bR2},${-bR2} v${-(height - bR2 * 2)} a${bR2},${bR2} 0 0 1 ${bR2},${-bR2} h${width / 2 - bR2}`;
    }
    const bR = Math.min(borderRadius, height / 2);
    if (hasPositive) {
      return `M${Math.min(xOrigin, x2 - bR)},${y2} h${width} a${bR},${bR} 0 0 1 ${bR},${bR} v${height - bR * 2} a${bR},${bR} 0 0 1 ${-bR},${bR} h${-width} Z`;
    }
    if (hasNegative) {
      return `M${Math.max(xOrigin, x2 + width + bR)},${y2} h${-width} a${bR},${bR} 0 0 0 ${-bR},${bR} v${height - bR * 2} a${bR},${bR} 0 0 0 ${bR},${bR} h${width} Z`;
    }
  }
  return void 0;
}

// node_modules/@mui/x-charts/BarChart/useRegisterItemClickHandlers.mjs
...
function useRegisterItemClickHandlers(onItemClick) {
  ...
  React31.useEffect(() => {
    ...
    const onClick = function onClick2(event) {
      let point6 = event;
      if (lastPointerUp) {
      ...
      lastPointerUp = null;
      const svgPoint = getChartPoint(element, point6);
    ...
    const onPointerUp = function onPointerUp2(event) {
      lastPointerUp = event;
    };
...
var _excluded8 = ["completedData", "masksData", "borderRadius", "onItemClick", "skipAnimation"];
function IndividualBarPlot(_ref) {
  ...
  return (0, import_jsx_runtime9.jsxs)(React32.Fragment, {
    children: [!withoutBorderRadius && masksData.map(({
      ...
      return (0, import_jsx_runtime9.jsx)(BarClipPath, {
        maskId: id,
        borderRadius,
        hasNegative,
        hasPositive,
      ...
      return (0, import_jsx_runtime9.jsx)("g", {
        ...
        children: data.map(({
          ...
          const barElement = (0, import_jsx_runtime9.jsx)(BarElement, _extends({
            seriesId,
            dataIndex,
            color: color2,
            skipAnimation: skipAnimation ?? false,
...
// node_modules/@mui/x-charts/BarChart/BatchBarPlot/BatchBarPlot.mjs
var React34 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/internals/appendAtKey.mjs
function appendAtKey(map4, key, value) {
  let bucket = map4.get(key);
  if (!bucket) {
    bucket = [value];
    map4.set(key, bucket);
  } else {
...
// node_modules/@mui/x-charts/BarChart/BatchBarPlot/useCreateBarPaths.mjs
var MAX_POINTS_PER_PATH = 1e3;
function generateBarPath(x2, y2, width, height, topLeftBorderRadius, topRightBorderRadius, bottomRightBorderRadius, bottomLeftBorderRadius) {
...
// node_modules/@mui/x-charts/BarChart/BatchBarPlot/BarGroup.mjs
var React33 = __toESM(require_react(), 1);
var import_jsx_runtime10 = __toESM(require_jsx_runtime(), 1);
var _excluded9 = ["skipAnimation", "layout", "xOrigin", "yOrigin"];
var _excluded23 = ["children", "layout", "xOrigin", "yOrigin"];
var PathGroup = styled_default("g")({
  '&[data-faded="true"]': {
    opacity: 0.3
  },
  "& path": {
...
function BarGroup(_ref) {
  ...
  if (skipAnimation) {
    return (0, import_jsx_runtime10.jsx)(PathGroup, _extends({}, props));
  }
  return (0, import_jsx_runtime10.jsx)(AnimatedGroup, _extends({}, props, {
    layout,
    xOrigin,
    yOrigin
  }));
...
function AnimatedGroup(_ref2) {
  ...
  if (layout === "horizontal") {
    animateChildren.push((0, import_jsx_runtime10.jsx)(AnimatedRect, {
      "data-orientation": "horizontal",
      x: drawingArea.left,
  ...
  return (0, import_jsx_runtime10.jsxs)(React33.Fragment, {
    ...
    }), (0, import_jsx_runtime10.jsx)(PathGroup, _extends({
...
function BatchBarPlot({
  ...
  useRegisterItemClickHandlers(onItemClick);
  return (0, import_jsx_runtime11.jsx)(React34.Fragment, {
    children: completedData.map((series) => (0, import_jsx_runtime11.jsx)(SeriesBatchPlot, {
      series,
      borderRadius,
      skipAnimation
    }, series.seriesId))
...
var MemoFadedHighlightedBars = React34.memo(FadedHighlightedBars);
if (true) MemoFadedHighlightedBars.displayName = "MemoFadedHighlightedBars";
function SeriesBatchPlot({
  ...
  const isSeriesHighlighted2 = store.use(selectorChartIsSeriesHighlighted, series.seriesId);
  const isSeriesFaded2 = store.use(selectorChartIsSeriesFaded, series.seriesId);
  return (0, import_jsx_runtime11.jsxs)(React34.Fragment, {
    children: [(0, import_jsx_runtime11.jsx)(BarGroup, {
      className: classes.series,
      ...
      skipAnimation,
      "data-faded": isSeriesFaded2 || void 0,
      "data-highlighted": isSeriesHighlighted2 || void 0,
      children: (0, import_jsx_runtime11.jsx)(BatchBarSeriesPlot, {
        processedSeries: series,
        borderRadius
      })
    }), (0, import_jsx_runtime11.jsx)(MemoFadedHighlightedBars, {
      processedSeries: series,
      borderRadius
    })]
  });
...
function BatchBarSeriesPlot({
  ...
  for (const [fill, dArray] of paths.entries()) {
    for (const d of dArray) {
      children.push((0, import_jsx_runtime11.jsx)("path", {
        fill,
        d
      }, i));
      i += 1;
...
function FadedHighlightedBars({
  ...
  if (seriesHighlightedItem != null) {
    siblings.push((0, import_jsx_runtime11.jsx)("path", {
...
var _excluded10 = ["className", "skipAnimation", "onItemClick", "borderRadius", "renderer"];
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime12.jsxs)(BarPlotRoot, {
    className: clsx_default(classes.root, className),
    children: [(0, import_jsx_runtime12.jsx)(BarElementPlot, _extends({
      completedData,
      masksData,
      skipAnimation: renderer === "svg-batch" ? batchSkipAnimation : skipAnimation,
      onItemClick,
      borderRadius
    }, other)), completedData.map((processedSeries) => (0, import_jsx_runtime12.jsx)(BarLabelPlot, _extends({
...
true ? BarPlot.propTypes = {
   ...
   * @default 'svg-single'
   */
  renderer: import_prop_types5.default.oneOf(["svg-batch", "svg-single"]),
  /**
...
// node_modules/@mui/x-charts/ChartsAxis/ChartsAxis.mjs
var React46 = __toESM(require_react(), 1);
var import_prop_types9 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/ChartsXAxis/ChartsXAxis.mjs
var import_prop_types7 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/ChartsXAxis/ChartsXAxisImpl.mjs
var React42 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/ChartsXAxis/ChartsSingleXAxisTicks.mjs
var React39 = __toESM(require_react(), 1);

// node_modules/@mui/x-internals/useIsHydrated/useIsHydrated.mjs
...
function useIsHydrated() {
  return React36.useSyncExternalStore(emptySubscribe, getSnapshot, getServerSnapshot);
}

// node_modules/@mui/x-charts/hooks/useMounted.mjs
...
// node_modules/@mui/x-charts/internals/degToRad.mjs
function degToRad(degrees3) {
  return degrees3 * (Math.PI / 180);
}

// node_modules/@mui/x-charts/internals/sliceUntil.mjs
var segmenter2 = typeof window !== "undefined" && "Intl" in window && "Segmenter" in Intl ? (
  // eslint-disable-next-line compat/compat
  new Intl.Segmenter(void 0, {
    granularity: "grapheme"
  })
...
// node_modules/@mui/x-charts/internals/ellipsize.mjs
var ELLIPSIS = "…";
...
// node_modules/@mui/x-charts/ChartsXAxis/shortenLabels.mjs
...
// node_modules/@mui/x-charts/internals/geometry.mjs
var ANGLE_APPROX = 5;
...
// node_modules/@mui/x-charts/ChartsXAxis/getVisibleLabels.mjs
function getVisibleLabels(xTicks, {
  ...
  const sizeMap = measureTickLabels2(candidateTickLabels, style);
...
function measureTickLabels2(ticks2, style) {
...
// node_modules/@mui/x-charts/ChartsText/ChartsText.mjs
var React38 = __toESM(require_react(), 1);
var import_prop_types6 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/internals/getWordsByLines.mjs
...
function ChartsText(props) {
  ...
  const wordsByLines = React38.useMemo(() => getWordsByLines({
    style,
...
// node_modules/@mui/x-charts/ChartsText/defaultTextPlacement.mjs
...
// node_modules/@mui/x-charts/internals/invertTextAnchor.mjs
...
// node_modules/@mui/x-charts/ChartsXAxis/useAxisTicksProps.mjs
...
function ChartsSingleXAxisTicks(inProps) {
  ...
  return (0, import_jsx_runtime14.jsx)(React39.Fragment, {
...
// node_modules/@mui/x-charts/ChartsXAxis/ChartsGroupedXAxisTicks.mjs
var React41 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/hooks/useTicksGrouped.mjs
...
// node_modules/@mui/x-charts/internals/getGroupingConfig.mjs
var DEFAULT_GROUPING_CONFIG = {
  tickSize: 6
};
var getGroupingConfig = (groups2, groupIndex, tickSize, computedGroupTickSizes) => {
  ...
  return _extends({}, DEFAULT_GROUPING_CONFIG, config, {
    tickSize: (computedGroupTickSizes == null ? void 0 : computedGroupTickSizes[groupIndex]) ?? config.tickSize ?? calculatedTickSize
  });
};
...
function ChartsGroupedXAxisTicks(inProps) {
  ...
  if (!isOrdinalScale(xScale)) {
    throw new Error(true ? "MUI X Charts: ChartsGroupedXAxis only supports the `band` and `point` scale types. Grouped axis ticks require an ordinal scale to display category groupings. Use a band or point scale type for the x-axis, or use a non-grouped axis component." : formatErrorMessage(8));
  }
  const {
    disableTicks,
    tickSize,
  ...
  const axisAutoSizeResult = axisId ? autoSizeResults[axisId] : void 0;
  const computedGroupTickSizes = axisAutoSizeResult == null ? void 0 : axisAutoSizeResult.groupTickSizes;
  ...
  return (0, import_jsx_runtime15.jsx)(React41.Fragment, {
    children: xTicks.map((item, index2) => {
      const {
        offset: tickOffset,
        labelOffset
      ...
      const groupConfig = getGroupingConfig(groups2, groupIndex, tickSize, computedGroupTickSizes);
      ...
      return (0, import_jsx_runtime15.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime15.jsx)(Tick, _extends({
          y2: tickYSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime15.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: labelPositionY
        }, axisTickLabelProps, {
...
// node_modules/@mui/x-charts/internals/components/AxisSharedComponents.mjs
...
function ChartsXAxisImpl(_ref) {
  let {
    axis
  } = _ref, inProps = _objectWithoutPropertiesLoose(_ref, _excluded13);
  const {
    scale: xScale,
    ordinalTimeTicks
  ...
  if (!skipTickRendering) {
    children = "groups" in axis && Array.isArray(axis.groups) ? (0, import_jsx_runtime16.jsx)(ChartsGroupedXAxisTicks, _extends({}, inProps)) : (0, import_jsx_runtime16.jsx)(ChartsSingleXAxisTicks, _extends({}, inProps, {
  ...
  return (0, import_jsx_runtime16.jsxs)(XAxisRoot, {
    ...
    }, slotProps == null ? void 0 : slotProps.axisLine)), children, label && (0, import_jsx_runtime16.jsx)("g", {
      className: classes.label,
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime17.jsx)(ChartsXAxisImpl, _extends({}, inProps, {
    axis
  }));
}
true ? ChartsXAxis.propTypes = {
   ...
   * @default 0
   */
  tickSpacing: import_prop_types7.default.number
} : void 0;

// node_modules/@mui/x-charts/ChartsYAxis/ChartsYAxis.mjs
var import_prop_types8 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/ChartsYAxis/ChartsYAxisImpl.mjs
var React45 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/ChartsYAxis/ChartsSingleYAxisTicks.mjs
var React43 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/ChartsYAxis/shortenLabels.mjs
...
// node_modules/@mui/x-charts/ChartsYAxis/utilities.mjs
...
// node_modules/@mui/x-charts/ChartsYAxis/useAxisTicksProps.mjs
...
function ChartsSingleYAxisTicks(inProps) {
  ...
  return (0, import_jsx_runtime18.jsx)(React43.Fragment, {
    children: yTicks.map((item, index2) => {
      ...
      return (0, import_jsx_runtime18.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime18.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime18.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
...
// node_modules/@mui/x-charts/ChartsYAxis/ChartsGroupedYAxisTicks.mjs
...
function ChartsGroupedYAxisTicks(inProps) {
  ...
  if (!isOrdinalScale(yScale)) {
    throw new Error(true ? "MUI X Charts: ChartsGroupedYAxis only supports the `band` and `point` scale types. Grouped axis ticks require an ordinal scale to display category groupings. Use a band or point scale type for the y-axis, or use a non-grouped axis component." : formatErrorMessage(9));
  }
  const {
    disableTicks,
    tickSize,
  ...
  return (0, import_jsx_runtime19.jsx)(React44.Fragment, {
    children: yTicks.map((item, index2) => {
      const {
        offset: tickOffset,
        labelOffset
      ...
      return (0, import_jsx_runtime19.jsxs)("g", {
        ...
        className: classes.tickContainer,
        "data-group-index": groupIndex,
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime19.jsx)(Tick, _extends({
          x2: tickXSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime19.jsx)(TickLabel, _extends({
          x: labelPositionX,
          y: yTickLabel
        }, axisTickLabelProps, {
          style: _extends({}, axisTickLabelProps.style, groupConfig.tickLabelStyle),
...
var _excluded15 = ["axis"];
var _excluded26 = ["scale", "tickNumber", "reverse", "ordinalTimeTicks"];
...
function ChartsYAxisImpl(_ref) {
  let {
    axis
  } = _ref, inProps = _objectWithoutPropertiesLoose(_ref, _excluded15);
  const {
    scale: yScale,
    ordinalTimeTicks
  } = axis, settings = _objectWithoutPropertiesLoose(axis, _excluded26);
  const isHydrated = useIsHydrated();
  const themedProps = useThemeProps({
    props: _extends({}, settings, inProps),
    name: "MuiChartsYAxis"
  ...
  let children = null;
  if (!skipTickRendering) {
    children = "groups" in axis && Array.isArray(axis.groups) ? (0, import_jsx_runtime20.jsx)(ChartsGroupedYAxisTicks, _extends({}, inProps)) : (0, import_jsx_runtime20.jsx)(ChartsSingleYAxisTicks, _extends({}, inProps, {
      axisLabelHeight,
      ordinalTimeTicks
    }));
  }
  return (0, import_jsx_runtime20.jsxs)(YAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime20.jsx)(Line, _extends({
      ...
      y2: top + height,
      className: classes.line
    }, lineProps)), children, label && isHydrated && (0, import_jsx_runtime20.jsx)("g", {
      className: classes.label,
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime21.jsx)(ChartsYAxisImpl, _extends({}, inProps, {
    axis
  }));
}
true ? ChartsYAxis.propTypes = {
   ...
   * @default 0
   */
  tickSpacing: import_prop_types8.default.number
} : void 0;
...
function ChartsAxis(props) {
  ...
  const XAxis = (slots == null ? void 0 : slots.xAxis) ?? ChartsXAxis;
  const YAxis = (slots == null ? void 0 : slots.yAxis) ?? ChartsYAxis;
  return (0, import_jsx_runtime22.jsxs)(React46.Fragment, {
    children: [xAxisIds.map((axisId) => {
      if (!xAxis[axisId].position || xAxis[axisId].position === "none") {
        return null;
      }
      return (0, import_jsx_runtime22.jsx)(XAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
      ...
      return (0, import_jsx_runtime22.jsx)(YAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
...
function useInternalItemTooltip() {
  ...
  const itemSeries = (_a2 = series[identifier.type]) == null ? void 0 : _a2.series[identifier.seriesId];
  if (!itemSeries) {
    return null;
  }
  ...
  const getColor5 = seriesConfig[itemSeries.type].colorProcessor(itemSeries, mainAxis, secondAxis, colorAxisId !== void 0 ? zAxis[colorAxisId] : void 0);
  const axesConfig = {};
  if (xAxisId !== void 0) {
...
var ChartsTooltipPaper = styled_default("div", {
  ...
  return {
    ...
    borderRadius: (_a2 = (theme.vars || theme).shape) == null ? void 0 : _a2.borderRadius,
...
var consumeThemeProps = (name, options, InComponent) => React47.forwardRef(function ConsumeThemeInternal(props, ref) {
  var _a2;
  const themedProps = useThemeProps({
    props,
  ...
  const theme = useTheme();
  const classes = (_a2 = options.classesResolver) == null ? void 0 : _a2.call(options, outProps, theme);
  const OutComponent = React47.forwardRef(InComponent);
  if (true) OutComponent.displayName = "OutComponent";
  if (true) {
    OutComponent.displayName = `consumeThemeProps(${name})`;
  }
  return (0, import_jsx_runtime23.jsx)(OutComponent, _extends({}, outProps, {
    classes,
    ref
  }));
});
...
var _excluded16 = ["type", "markShape", "color", "className", "classes"];
...
var ChartsLabelMark = consumeThemeProps("MuiChartsLabelMark", {
  ...
  const theme = useTheme();
  return (0, import_jsx_runtime24.jsx)(Root, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ownerState: props,
    "aria-hidden": "true",
    ref
  }, other, {
    children: typeof Component === "function" ? (0, import_jsx_runtime24.jsx)(Component, {
      className: classes == null ? void 0 : classes.fill,
      color: color2
    }) : (0, import_jsx_runtime24.jsxs)(React48.Fragment, {
      children: [type === "circle" && (0, import_jsx_runtime24.jsx)("svg", {
        viewBox: "0 0 15 15",
      ...
      }), type === "line" && (0, import_jsx_runtime24.jsx)("svg", {
        viewBox: "0 0 16 8",
      ...
      }), type === "line+mark" && (0, import_jsx_runtime24.jsxs)("svg", {
        viewBox: "0 0 16 16",
        preserveAspectRatio: "none",
        children: [(0, import_jsx_runtime24.jsx)("path", {
          className: classes == null ? void 0 : classes.fill,
          ...
          strokeLinecap: "round",
          vectorEffect: "non-scaling-stroke"
        }), markShape && (0, import_jsx_runtime24.jsx)("path", {
      ...
      }), type !== "line" && type !== "circle" && type !== "line+mark" && (0, import_jsx_runtime24.jsx)("svg", {
        viewBox: "0 0 13 13",
  ...
  if ("values" in tooltipData) {
    ...
    return (0, import_jsx_runtime25.jsx)(ChartsTooltipPaper, {
      ...
      children: (0, import_jsx_runtime25.jsxs)(ChartsTooltipTable, {
        ...
        children: [(0, import_jsx_runtime25.jsxs)(Typography_default, {
          component: "caption",
          ...
          children: (0, import_jsx_runtime25.jsx)(Content2, {
            classes: propClasses,
            item: tooltipData
          })
        })]
  ...
  return (0, import_jsx_runtime25.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime25.jsx)(ChartsTooltipTable, {
      ...
      children: (0, import_jsx_runtime25.jsx)("tbody", {
        children: (0, import_jsx_runtime25.jsx)(Content, {
          classes: propClasses,
          item: (
...
function DefaultMultipleValueContent({
  ...
  return (0, import_jsx_runtime25.jsx)(React49.Fragment, {
    children: item.values.map((value) => (0, import_jsx_runtime25.jsxs)(ChartsTooltipRow, {
...
true ? DefaultMultipleValueContent.propTypes = {
  // ----------------------------- Warning --------------------------------
  // | These PropTypes are generated from the TypeScript type definitions |
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  ...
  item: import_prop_types10.default.shape({
    ...
    identifier: import_prop_types10.default.shape({
      dataIndex: import_prop_types10.default.number,
      seriesId: import_prop_types10.default.string.isRequired,
      type: import_prop_types10.default.oneOf(["radar"]).isRequired
    }).isRequired,
    label: import_prop_types10.default.string,
    markShape: import_prop_types10.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]),
    markType: import_prop_types10.default.oneOfType([import_prop_types10.default.oneOf(["circle", "line", "line+mark", "square"]), import_prop_types10.default.func]),
    values: import_prop_types10.default.arrayOf(import_prop_types10.default.shape({
      formattedValue: import_prop_types10.default.string,
      label: import_prop_types10.default.string,
      markShape: import_prop_types10.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]),
      markType: import_prop_types10.default.oneOfType([import_prop_types10.default.oneOf(["circle", "line", "line+mark", "square"]), import_prop_types10.default.func]),
...
function DefaultSingleValueContent({
  ...
  return (0, import_jsx_runtime25.jsxs)(ChartsTooltipRow, {
    ...
    children: [(0, import_jsx_runtime25.jsxs)(ChartsTooltipCell, {
      className: clsx_default(classes.labelCell, classes.cell),
      component: "th",
      children: [(0, import_jsx_runtime25.jsx)("div", {
        className: classes.markContainer,
...
true ? DefaultSingleValueContent.propTypes = {
  // ----------------------------- Warning --------------------------------
  // | These PropTypes are generated from the TypeScript type definitions |
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  ...
  item: import_prop_types10.default.shape({
    color: import_prop_types10.default.string.isRequired,
    formattedValue: import_prop_types10.default.any.isRequired,
    identifier: import_prop_types10.default.shape({
      dataIndex: import_prop_types10.default.number,
      seriesId: import_prop_types10.default.string.isRequired,
      type: import_prop_types10.default.oneOf(["bar", "line", "pie", "radar", "scatter"]).isRequired
    }).isRequired,
    label: import_prop_types10.default.string,
    markShape: import_prop_types10.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]),
    markType: import_prop_types10.default.oneOfType([import_prop_types10.default.oneOf(["circle", "line", "line+mark", "square"]), import_prop_types10.default.func]),
...
function useColorProcessor(seriesType) {
  const store = useStore2();
  const seriesConfig = store.use(selectorChartSeriesConfig);
  const colorProcessors = React50.useMemo(() => {
    const rep = {};
...
function defaultAxisTooltipConfig(axis, dataIndex, axisDirection) {
  var _a2;
  const axisValue = ((_a2 = axis.data) == null ? void 0 : _a2[dataIndex]) ?? null;
  ...
  Object.keys(series).filter((seriesType) => composableCartesianSeriesTypes.has(seriesType)).forEach((seriesType) => {
    ...
    return seriesOfType.seriesOrder.forEach((seriesId) => {
      ...
      if (tooltipItemIndex >= 0) {
        ...
        const color2 = ((_a2 = colorProcessors[seriesType]) == null ? void 0 : _a2.call(colorProcessors, seriesToAdd, xAxis[providedXAxisId], yAxis[providedYAxisId], colorAxisId ? zAxis[colorAxisId] : void 0)(dataIndex)) ?? "";
  ...
  Object.keys(series).filter(isPolarSeriesType).forEach((seriesType) => {
    ...
    return seriesOfType.seriesOrder.forEach((seriesId) => {
      ...
      if (tooltipItemIndex >= 0) {
        ...
        const color2 = ((_a2 = colorProcessors[seriesType]) == null ? void 0 : _a2.call(colorProcessors, seriesToAdd, providedRotationAxisId !== void 0 ? rotationAxis[providedRotationAxisId] : void 0, providedRadiusAxisId !== void 0 ? radiusAxis[providedRadiusAxisId] : void 0)(dataIndex)) ?? "";
  ...
  return (0, import_jsx_runtime26.jsx)(ChartsTooltipPaper, {
    ...
    children: tooltipData.map(({
      ...
      const sortedItems = sort3 && sort3 !== "none" ? [...seriesItems].sort((a2, b) => {
        var _a2, _b;
        const aValue = (_a2 = a2.value) == null ? void 0 : _a2.valueOf();
      ...
      return (0, import_jsx_runtime26.jsxs)(ChartsTooltipTable, {
        className: classes.table,
        children: [axisValue != null && !mainAxis.hideTooltip && (0, import_jsx_runtime26.jsx)(Typography_default, {
          component: "caption",
          ...
          children: sortedItems.map((item) => {
            ...
            return (0, import_jsx_runtime26.jsx)(Content, {
...
function DefaultContent(props) {
  ...
  return (0, import_jsx_runtime26.jsxs)(ChartsTooltipRow, {
    ...
    children: [(0, import_jsx_runtime26.jsxs)(ChartsTooltipCell, {
      className: clsx_default(classes.labelCell, classes.cell),
      component: "th",
      children: [(0, import_jsx_runtime26.jsx)("div", {
        className: classes.markContainer,
        children: (0, import_jsx_runtime26.jsx)(ChartsLabelMark, {
          type: item.markType,
...
true ? DefaultContent.propTypes = {
  ...
  item: import_prop_types11.default.shape({
    ...
    formattedLabel: import_prop_types11.default.string,
    formattedValue: import_prop_types11.default.string.isRequired,
    markShape: import_prop_types11.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]),
    markType: import_prop_types11.default.oneOfType([import_prop_types11.default.oneOf(["circle", "line", "line+mark", "square"]), import_prop_types11.default.func]),
    seriesId: import_prop_types11.default.string.isRequired,
    value: import_prop_types11.default.oneOfType([import_prop_types11.default.number, import_prop_types11.default.shape({
      colorValue: import_prop_types11.default.any,
      id: import_prop_types11.default.oneOfType([import_prop_types11.default.number, import_prop_types11.default.string]),
      sizeValue: import_prop_types11.default.any,
      x: import_prop_types11.default.number.isRequired,
      y: import_prop_types11.default.number.isRequired,
      z: import_prop_types11.default.any
    })])
  }).isRequired
} : void 0;
true ? ChartsAxisTooltipContent.propTypes = {
   ...
   * @default 'none'
   */
  sort: import_prop_types11.default.oneOf(["asc", "desc", "none"]),
...
// node_modules/@mui/material/NoSsr/NoSsr.mjs
...
var _excluded17 = ["trigger", "position", "anchor", "classes", "children"];
...
function ChartsTooltipContainer(inProps) {
  ...
  const store = useStore2();
  if (true) {
    const isItemControlled = ((_a2 = store.state.tooltip) == null ? void 0 : _a2.itemIsControlled) ?? false;
  ...
  const seriesConfig = store.use(selectorChartSeriesConfig);
  const selectorItemPosition = tooltipItem && ((_b = seriesConfig[tooltipItem.type]) == null ? void 0 : _b.selectorTooltipItemPosition) || selectorReturnNull;
  ...
  React52.useEffect(() => {
    ...
    const pointerUpdate = rafThrottle((x2, y2) => {
      ...
      (_a3 = popperRef.current) == null ? void 0 : _a3.update();
    });
  ...
  useEnhancedEffect_default(() => {
    ...
    (_a3 = popperRef.current) == null ? void 0 : _a3.update();
  }, [isTooltipNodeAnchored, itemPosition == null ? void 0 : itemPosition.x, itemPosition == null ? void 0 : itemPosition.y]);
  const pointerAnchorEl = React52.useMemo(() => ({
  ...
  return (0, import_jsx_runtime27.jsxs)(React52.Fragment, {
    children: [chartsLayerContainerRef.current && ReactDOM.createPortal((0, import_jsx_runtime27.jsx)("div", {
      ref: setAnchorEl,
      style: {
        position: "absolute",
        display: "hidden",
    ...
    }), chartsLayerContainerRef.current), (0, import_jsx_runtime27.jsx)(NoSsr_default, {
...
true ? ChartsTooltipContainer.propTypes = {
   ...
   * @default 'pointer'
   */
  anchor: import_prop_types13.default.oneOf(["chart", "node", "pointer"]),
  /**
  ...
  container: import_prop_types13.default.oneOfType([(props, propName) => {
    if (props[propName] == null) {
      return new Error(true ? `Prop '${propName}' is required but wasn't specified` : formatErrorMessage(6, propName));
    }
    if (typeof props[propName] !== "object" || props[propName].nodeType !== 1) {
      return new Error(true ? `Expected prop '${propName}' to be of type Element` : formatErrorMessage(49, propName));
    }
    return null;
...
var _excluded18 = ["classes", "trigger", "sort"];
function ChartsTooltip(props) {
  const {
    classes: propClasses,
    trigger = "axis",
    sort: sort3
  } = props, containerProps = _objectWithoutPropertiesLoose(props, _excluded18);
  const classes = useUtilityClasses4(propClasses);
  return (0, import_jsx_runtime28.jsx)(ChartsTooltipContainer, _extends({}, containerProps, {
    trigger,
    classes: propClasses,
    children: trigger === "axis" ? (0, import_jsx_runtime28.jsx)(ChartsAxisTooltipContent, {
      classes,
      sort: sort3
    }) : (0, import_jsx_runtime28.jsx)(ChartsItemTooltipContent, {
      classes
    })
  }));
}
true ? ChartsTooltip.propTypes = {
   ...
   * @default 'pointer'
   */
  anchor: import_prop_types14.default.oneOf(["chart", "node", "pointer"]),
  /**
   * An HTML element, [virtualElement](https://popper.js.org/docs/v2/virtual-elements/),
   * or a function that returns either.
   * It's used to set the position of the popper.
   ...
   * @default 'none'
   */
  sort: import_prop_types14.default.oneOf(["asc", "desc", "none"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  function ConsumeSlotsInternal(props, ref) {
    ...
    const theme = useTheme();
    const classes = (_a2 = options.classesResolver) == null ? void 0 : _a2.call(options, defaultizedProps, theme);
    ...
    const _useSlotProps = useSlotProps_default({
      ...
      ownerState: {}
    }), originalOutProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded27);
    ...
    return (0, import_jsx_runtime29.jsx)(Component, _extends({}, outProps, {
      ref
    }));
  }
...
var _excluded20 = ["children", "className", "classes"];
var ChartsLabel = consumeThemeProps("MuiChartsLabel", {
  ...
  return (0, import_jsx_runtime30.jsx)("span", _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    children
...
var _excluded21 = ["direction", "onItemClick", "className", "classes", "toggleVisibilityOnClick"];
...
var ChartsLegend = consumeSlots("MuiChartsLegend", "legend", {
  ...
  return (0, import_jsx_runtime31.jsx)(RootElement, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
...
true ? ChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types16.default.oneOf(["horizontal", "vertical"]),
  /**
   ...
   * @default false
   */
  toggleVisibilityOnClick: import_prop_types16.default.bool
} : void 0;
...
var _excluded28 = ["gradientId", "direction", "classes", "className", "rotate", "reverse", "thickness"];
...
var ChartsLabelGradient = consumeThemeProps("MuiChartsLabelGradient", {
  ...
  const isRtl = useRtl();
  return (0, import_jsx_runtime32.jsx)(Root2, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ...
    children: (0, import_jsx_runtime32.jsx)("div", {
      ...
      children: (0, import_jsx_runtime32.jsx)("svg", {
        viewBox: "0 0 24 24",
...
true ? ChartsLabelGradient.propTypes = {
   ...
   * @default 'horizontal'
   */
  direction: import_prop_types17.default.oneOf(["vertical", "horizontal"]),
  /**
   * A unique identifier for the gradient.
   * The `gradientId` will be used as `fill="url(#gradientId)"`.
   */
  gradientId: import_prop_types17.default.string.isRequired,
  /**
   ...
   */
  rotate: import_prop_types17.default.bool,
  /**
...
var _excluded29 = ["minLabel", "maxLabel", "direction", "axisDirection", "axisId", "rotateGradient", "reverse", "classes", "className", "gradientId", "labelPosition", "thickness"];
...
var ContinuousColorLegend = consumeThemeProps("MuiContinuousColorLegend", {
  ...
  const minComponent = (0, import_jsx_runtime33.jsx)("li", {
    className: classes == null ? void 0 : classes.minLabel,
    children: (0, import_jsx_runtime33.jsx)(ChartsLabel, {
      className: classes == null ? void 0 : classes.label,
      children: minText
    })
  });
  const maxComponent = (0, import_jsx_runtime33.jsx)("li", {
  ...
  return (0, import_jsx_runtime33.jsxs)(RootElement2, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: [reverse2 ? maxComponent : minComponent, (0, import_jsx_runtime33.jsx)("li", {
      className: classes == null ? void 0 : classes.gradient,
      children: (0, import_jsx_runtime33.jsx)(ChartsLabelGradient, {
        direction,
...
true ? ContinuousColorLegend.propTypes = {
   ...
   */
  gradientId: import_prop_types18.default.string,
  /**
   ...
   * Useful for linear gradients that are not in the correct orientation.
   */
  rotateGradient: import_prop_types18.default.bool,
  /**
   * The thickness of the gradient
   * @default 12
   */
...
var CORRECT_PREFIX = "MuiPiecewiseColorLegend";
var LEGACY_PREFIX = "MuiPiecewiseColorLegendClasses";
...
var piecewiseColorLegendClasses = generateUtilityClasses(CORRECT_PREFIX, ["root", "minLabel", "maxLabel", "item", "vertical", "horizontal", "start", "end", "extremes", "inlineStart", "inlineEnd", "mark", "label"]);
...
var _excluded30 = ["direction", "classes", "className", "markType", "labelPosition", "axisDirection", "axisId", "labelFormatter", "onItemClick"];
...
var PiecewiseColorLegend = consumeThemeProps("MuiPiecewiseColorLegend", {
  ...
  const valueFormatter = (v) => {
    var _a2;
    return ((_a2 = axisItem.valueFormatter) == null ? void 0 : _a2.call(axisItem, v, {
      location: "legend"
    })) ?? v.toLocaleString();
  };
  ...
  return (0, import_jsx_runtime34.jsx)(RootElement3, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: orderedColors.map(({
      ...
      return (0, import_jsx_runtime34.jsx)("li", {
        children: (0, import_jsx_runtime34.jsxs)(Element, {
          ...
          children: [isTextBefore && (0, import_jsx_runtime34.jsx)(ChartsLabel, {
            className: classes == null ? void 0 : classes.label,
            children: label
          }), (0, import_jsx_runtime34.jsx)(ChartsLabelMark, {
            className: classes == null ? void 0 : classes.mark,
            type: markType,
            color: color2
          }), isTextAfter && (0, import_jsx_runtime34.jsx)(ChartsLabel, {
            className: classes == null ? void 0 : classes.label,
            children: label
          })]
        })
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'extremes'
   */
  labelPosition: import_prop_types19.default.oneOf(["start", "end", "extremes", "inline-start", "inline-end"]),
  /**
   * The type of the mark.
   * @default 'square'
   */
  markType: import_prop_types19.default.oneOf(["square", "circle", "line"]),
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<HTMLButtonElement, MouseEvent>} event The click event.
...
// node_modules/@mui/x-charts/ChartsAxisHighlight/ChartsAxisHighlight.mjs
var React61 = __toESM(require_react(), 1);
var import_prop_types20 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/ChartsAxisHighlight/chartsAxisHighlightClasses.mjs
function getAxisHighlightUtilityClass(slot) {
  return generateUtilityClass("MuiChartsAxisHighlight", slot);
}
var chartsAxisHighlightClasses = generateUtilityClasses("MuiChartsAxisHighlight", ["root"]);

// node_modules/@mui/x-charts/ChartsAxisHighlight/ChartsYAxisHighlight.mjs
var React59 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/ChartsAxisHighlight/ChartsAxisHighlightPath.mjs
...
// node_modules/@mui/x-charts/ChartsAxisHighlight/getSampledBandHighlight.mjs
function getSampledBandHighlight({
  ...
  if (bucketSize > 1 && data) {
    const index2 = dataIndex ?? data.indexOf(value);
    if (index2 >= 0) {
      const bucketStart = Math.floor(index2 / bucketSize) * bucketSize;
...
function ChartsYHighlight(props) {
  ...
  return axisYValues.map((axisValue) => {
    ...
    return (0, import_jsx_runtime35.jsxs)(React59.Fragment, {
      children: [isYScaleOrdinal && yScale(value) !== void 0 && (0, import_jsx_runtime35.jsx)(ChartsAxisHighlightPath, {
        d: `M ${left} ${bandStart} l 0 ${bandSize} l ${width} 0 l 0 ${-bandSize} Z`,
        className: classes.root,
        ownerState: {
          axisHighlight: "band"
        }
      }), type === "line" && value !== null && (0, import_jsx_runtime35.jsx)(ChartsAxisHighlightPath, {
...
// node_modules/@mui/x-charts/ChartsAxisHighlight/ChartsXAxisHighlight.mjs
...
function ChartsXHighlight(props) {
  ...
  return axisXValues.map((axisValue) => {
    ...
    return (0, import_jsx_runtime36.jsxs)(React60.Fragment, {
      children: [isXScaleOrdinal && xScale(value) !== void 0 && (0, import_jsx_runtime36.jsx)(ChartsAxisHighlightPath, {
        d: `M ${bandStart} ${top} l ${bandSize} 0 l 0 ${height} l ${-bandSize} 0 Z`,
        className: classes.root,
        ownerState: {
          axisHighlight: "band"
        }
      }), type === "line" && value !== null && (0, import_jsx_runtime36.jsx)(ChartsAxisHighlightPath, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime37.jsxs)(React61.Fragment, {
    children: [xAxisHighlight && xAxisHighlight !== "none" && (0, import_jsx_runtime37.jsx)(ChartsXHighlight, {
      type: xAxisHighlight,
      classes
    }), yAxisHighlight && yAxisHighlight !== "none" && (0, import_jsx_runtime37.jsx)(ChartsYHighlight, {
      type: yAxisHighlight,
      classes
    })]
  });
...
// node_modules/@mui/x-charts/ChartsClipPath/ChartsClipPath.mjs
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime38.jsx)("clipPath", {
    id,
...
// node_modules/@mui/x-charts/ChartsGrid/ChartsGrid.mjs
var import_prop_types22 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-charts/ChartsGrid/chartsGridClasses.mjs
...
// node_modules/@mui/x-charts/ChartsGrid/styledComponents.mjs
...
// node_modules/@mui/x-charts/ChartsGrid/ChartsVerticalGrid.mjs
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime39.jsx)(React62.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => {
      var _a2;
      return !instance.isXInside(offset) ? null : (0, import_jsx_runtime39.jsx)(GridLine, {
        y1: start,
        y2: end,
        x1: offset,
        x2: offset,
        className: classes.verticalLine
      }, `vertical-${((_a2 = value == null ? void 0 : value.getTime) == null ? void 0 : _a2.call(value)) ?? value}`);
    })
  });
}

// node_modules/@mui/x-charts/ChartsGrid/ChartsHorizontalGrid.mjs
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(React63.Fragment, {
    children: yTicks.map(({
      ...
      var _a2;
      return !instance.isYInside(offset) ? null : (0, import_jsx_runtime40.jsx)(GridLine, {
        y1: offset,
        y2: offset,
        x1: start,
        x2: end,
        className: classes.horizontalLine
      }, `horizontal-${((_a2 = value == null ? void 0 : value.getTime) == null ? void 0 : _a2.call(value)) ?? value}`);
    })
  });
}
...
var _excluded31 = ["className", "vertical", "horizontal"];
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime41.jsxs)(GridRoot, _extends({}, other, {
    className: clsx_default(classes.root, className),
    children: [vertical && (0, import_jsx_runtime41.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      start: drawingArea.top,
      end: drawingArea.height + drawingArea.top,
      classes
    }), horizontal && (0, import_jsx_runtime41.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    const LoadingOverlay = ((_a2 = props.slots) == null ? void 0 : _a2.loadingOverlay) ?? ChartsLoadingOverlay;
...
// node_modules/@mui/x-charts/BarChart/useBarChartProps.mjs
var React65 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/BarChart/BarChart.plugins.mjs
var BAR_CHART_PLUGINS = [useChartZAxis, useChartBrush, useChartTooltip, useChartInteraction, useChartCartesianAxis, useChartHighlight, useChartVisibilityManager, useChartKeyboardNavigation];

// node_modules/@mui/x-charts/BarChart/useBarChartProps.mjs
var _excluded32 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "className", "hideLegend", "showToolbar", "brushConfig", "renderer"];
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React65.useMemo(() => [{
    id: DEFAULT_X_AXIS_KEY,
    scaleType: "band",
    data: Array.from({
  ...
  const defaultBandYAxis = React65.useMemo(() => [{
    id: DEFAULT_Y_AXIS_KEY,
    scaleType: "band",
    data: Array.from({
      length: Math.max(...series.map((s2) => (s2.data ?? dataset ?? []).length))
  ...
  const processedXAxis = React65.useMemo(() => {
    if (!xAxis) {
      return defaultXAxis;
    }
  ...
  const processedYAxis = React65.useMemo(() => {
    if (!yAxis) {
      return defaultYAxis;
    }
  ...
  const chartsContainerProps = _extends({}, other, {
    ...
    highlightedItem,
    onHighlightChange,
    disableAxisListener: ((_a2 = slotProps == null ? void 0 : slotProps.tooltip) == null ? void 0 : _a2.trigger) !== "axis" && (axisHighlight == null ? void 0 : axisHighlight.x) === "none" && (axisHighlight == null ? void 0 : axisHighlight.y) === "none",
    skipAnimation,
    brushConfig,
...
// node_modules/@mui/material/ToggleButton/ToggleButton.mjs
var React68 = __toESM(require_react(), 1);
var import_prop_types23 = __toESM(require_prop_types(), 1);

// node_modules/@mui/material/ToggleButtonGroup/ToggleButtonGroupContext.mjs
var React66 = __toESM(require_react(), 1);
var ToggleButtonGroupContext = React66.createContext({});
if (true) {
  ToggleButtonGroupContext.displayName = "ToggleButtonGroupContext";
}
var ToggleButtonGroupContext_default = ToggleButtonGroupContext;

// node_modules/@mui/material/ToggleButtonGroup/ToggleButtonGroupButtonContext.mjs
var React67 = __toESM(require_react(), 1);
var ToggleButtonGroupButtonContext = React67.createContext(void 0);
if (true) {
  ToggleButtonGroupButtonContext.displayName = "ToggleButtonGroupButtonContext";
}
var ToggleButtonGroupButtonContext_default = ToggleButtonGroupButtonContext;

// node_modules/@mui/material/ToggleButtonGroup/isValueSelected.mjs
...
var ToggleButton = React68.forwardRef(function ToggleButton2(inProps, ref) {
  const {
    value: contextValue,
    ...contextProps
  } = React68.useContext(ToggleButtonGroupContext_default);
  const toggleButtonGroupButtonContextPositionClassName = React68.useContext(ToggleButtonGroupButtonContext_default);
  ...
  return (0, import_jsx_runtime45.jsx)(ToggleButtonRoot, {
...
// node_modules/@mui/material/ToggleButtonGroup/ToggleButtonGroup.mjs
var React70 = __toESM(require_react(), 1);
var import_react_is = __toESM(require_react_is(), 1);
var import_prop_types24 = __toESM(require_prop_types(), 1);

// node_modules/@mui/utils/getValidReactChildren/getValidReactChildren.mjs
var React69 = __toESM(require_react(), 1);
function getValidReactChildren(children) {
  return React69.Children.toArray(children).filter((child) => React69.isValidElement(child));
}

// node_modules/@mui/material/ToggleButtonGroup/toggleButtonGroupClasses.mjs
function getToggleButtonGroupUtilityClass(slot) {
  return generateUtilityClass("MuiToggleButtonGroup", slot);
}
var toggleButtonGroupClasses = generateUtilityClasses("MuiToggleButtonGroup", ["root", "selected", "horizontal", "vertical", "disabled", "grouped", "fullWidth", "firstButton", "lastButton", "middleButton"]);
...
var ToggleButtonGroup = React70.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
  ...
  const handleChange = React70.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React70.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  return (0, import_jsx_runtime46.jsx)(ToggleButtonGroupRoot, {
    role: "group",
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
    ...other,
    children: (0, import_jsx_runtime46.jsx)(ToggleButtonGroupContext_default.Provider, {
      value: context,
      children: validChildren.map((child, index2) => {
        ...
        return (0, import_jsx_runtime46.jsx)(ToggleButtonGroupButtonContext_default.Provider, {
...
true ? ToggleButtonGroup.propTypes = {
   ...
   * @default false
   */
  exclusive: import_prop_types24.default.bool,
  /**
...
var ChartsSlotsContext = React71.createContext(null);
if (true) ChartsSlotsContext.displayName = "ChartsSlotsContext";
function useChartsSlots() {
  const context = React71.useContext(ChartsSlotsContext);
  if (context == null) {
...
function ChartsSlotsProvider(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(ChartsSlotsContext.Provider, {
    value,
    children
  });
}
...
var getBaseExtremum = (params) => {
  ...
  const data = filter2 ? (_a2 = axis.data) == null ? void 0 : _a2.filter((_, i) => filter2({
    x: null,
    y: null
  }, i)) : axis.data;
...
var getValueExtremum = (direction) => (params) => {
  ...
  return Object.keys(series).filter((seriesId) => {
    ...
    const [seriesMin, seriesMax] = (stackedDataToUse == null ? void 0 : stackedDataToUse.reduce((seriesAcc, values, index2) => {
...
function findVisibleDataIndex({
  ...
  const seriesItem = (_a2 = processedSeries[type]) == null ? void 0 : _a2.series[seriesId];
...
function seriesHasData(series, type, seriesId) {
  ...
  const data = (_b = (_a2 = series[type]) == null ? void 0 : _a2.series[seriesId]) == null ? void 0 : _b.data;
...
function createGetNextIndexFocusedItem(compatibleSeriesTypes, allowCycles = false, useCurrentSeriesMaxLength = false) {
  return function getNextIndexFocusedItem(currentItem, state) {
    ...
    const maxLength = useCurrentSeriesMaxLength ? ((_b = (_a2 = processedSeries[type]) == null ? void 0 : _a2.series[seriesId]) == null ? void 0 : _b.data.length) ?? 0 : getMaxSeriesLength(processedSeries, compatibleSeriesTypes);
...
function createCommonKeyboardFocusHandler(outSeriesTypes2, allowCycles, useCurrentSeriesMaxLength) {
  const keyboardFocusHandler5 = (event) => {
    switch (event.key) {
      case "ArrowRight":
        return createGetNextIndexFocusedItem(outSeriesTypes2, allowCycles, useCurrentSeriesMaxLength);
      case "ArrowLeft":
        return createGetPreviousIndexFocusedItem(outSeriesTypes2, allowCycles, useCurrentSeriesMaxLength);
      case "ArrowDown":
...
// node_modules/@mui/x-charts/internals/getLineLikeTooltip.mjs
...
var selectorTooltipItemPosition = createSelectorMemoized(selectorChartsTooltipItem, selectorChartSeriesProcessed, selectorChartXAxis, selectorChartYAxis, function selectorTooltipItemPosition2(identifier, series, xAxes, yAxes, placement) {
  var _a2;
  if (!identifier || identifier.type !== "bar" || identifier.dataIndex === void 0) {
    return null;
  }
  const itemSeries = (_a2 = series.bar) == null ? void 0 : _a2.series[identifier.seriesId];
...
var descriptionGetter = (params) => {
  ...
  const categoryValue = ((_a2 = categoryAxis.data) == null ? void 0 : _a2[identifier.dataIndex]) ?? null;
  const formattedValue = series.valueFormatter(value, {
    dataIndex: identifier.dataIndex
  });
...
var getExtremumY2 = (params) => {
  ...
  return Object.keys(series).filter((seriesId) => {
    ...
    const seriesExtremums = getSeriesExtremums(getValues, data, axis.domainSeries === "visible" ? visibleStackedData : stackedData, filter2);
    const [seriesMin, seriesMax] = seriesExtremums;
    return [Math.min(seriesMin, acc[0]), Math.max(seriesMax, acc[1])];
  }, [Infinity, -Infinity]);
};

// node_modules/@mui/x-charts/internals/processLineLikeSeries.mjs
...
function processLineLikeSeries(params, dataset, isItemVisible, seriesType) {
  ...
  seriesOrder.forEach((id, seriesIndex) => {
    ...
    if (data !== void 0) {
      ...
      throw new Error(true ? `MUI X Charts: ${titleCase} series with id="${id}" has no data. The chart cannot render this series without data. Provide a data property to the series or use the dataset prop.` : formatErrorMessage(276, titleCase, id));
    }
    if (true) {
      if (!data && dataset) {
        const dataKey = series[id].dataKey;
        ...
        if (dataKey) {
          ...
          dataset.forEach((entry, index2) => {
            const value = entry[dataKey];
            if (value != null && typeof value !== "number") {
              warnOnce(`MUI X Charts: your dataset key "${dataKey}" is used for plotting ${lowerCase}, but the dataset contains the non-null non-numerical element "${value}" at index ${index2}.
...
var seriesProcessor2 = (params, dataset, isItemVisible) => processLineLikeSeries(params, dataset, isItemVisible, "line");
var seriesProcessor_default2 = seriesProcessor2;

// node_modules/@mui/x-charts/LineChart/seriesConfig/getColor.mjs
var getColor2 = (series, xAxis, yAxis) => resolveColorProcessor({
  series,
  valueColorScale: yAxis == null ? void 0 : yAxis.colorScale,
  categoryColorScale: xAxis == null ? void 0 : xAxis.colorScale,
  categoryValues: xAxis == null ? void 0 : xAxis.data
});
...
var tooltipGetter2 = (params) => getLineLikeTooltip(params, {
...
var selectorTooltipItemPosition3 = createSelectorMemoized(selectorChartsTooltipItem, selectorChartSeriesProcessed, selectorChartXAxis, selectorChartYAxis, function selectorTooltipItemPosition4(identifier, series, xAxes, yAxes) {
  var _a2, _b;
  if (!identifier || identifier.type !== "line" || identifier.dataIndex === void 0) {
    return null;
  }
  const itemSeries = (_a2 = series.line) == null ? void 0 : _a2.series[identifier.seriesId];
  if (itemSeries == null) {
    return null;
  }
  const xAxis = xAxes.axis[itemSeries.xAxisId ?? xAxes.axisIds[0]];
  ...
  const xValue = (_b = xAxis.data) == null ? void 0 : _b[identifier.dataIndex];
...
function evaluateSegmentYAtX(segment, targetX) {
  ...
  const ease = bezier(nx1, ny1, nx2, ny2);
...
function getItemAtPosition(state, point6) {
  var _a2, _b;
  if (!((_a2 = state.experimentalFeatures) == null ? void 0 : _a2.enablePositionBasedPointerInteraction)) {
    return void 0;
  }
  const {
    axis: xAxes,
...
var descriptionGetter2 = (params) => {
  ...
  const xValue = ((_a2 = xAxis.data) == null ? void 0 : _a2[dataIndex]) ?? null;
...
var lineSeriesConfig = {
  ...
  selectorTooltipItemPosition: selectorTooltipItemPosition3,
    ...
    defaultizedSeries[seriesId] = _extends({
      ...
      data: series[seriesId].data.map((item, index2) => {
        ...
        return _extends({
          ...
          formattedValue: ((_b = (_a2 = series[seriesId]).valueFormatter) == null ? void 0 : _b.call(_a2, _extends({}, processedItem, {
...
var selectorTooltipItemPosition5 = createSelectorMemoized(selectorChartsTooltipItem, selectorChartSeriesProcessed, selectorChartSeriesLayout, function selectorTooltipItemPosition6(identifier, series, seriesLayout2, placement) {
  var _a2, _b;
  if (!identifier || identifier.type !== "pie" || identifier.dataIndex === void 0) {
    return null;
  }
  const itemSeries = (_a2 = series.pie) == null ? void 0 : _a2.series[identifier.seriesId];
...
var pieSeriesConfig = {
  ...
  selectorTooltipItemPosition: selectorTooltipItemPosition5,
...
// node_modules/@mui/x-charts/internals/incompleteDatasetKeysError.mjs
function incompleteDatasetKeysError(seriesType, seriesId, missingKeys) {
  throw new Error(true ? `MUI X Charts: ${seriesType} series with id="${seriesId}" has incomplete datasetKeys.Properties ${missingKeys.map((key) => `"${key}"`).join(", ")} are missing.` : formatErrorMessage(279, seriesType, seriesId, missingKeys.map((key) => `"${key}"`).join(", ")));
}
  ...
  const completeSeries = Object.fromEntries(Object.entries(series).map(([seriesId, seriesData]) => {
    ...
    if (seriesData.valueGetter) {
      ...
      data = (dataset == null ? void 0 : dataset.map((d) => {
        const x2 = d[datasetKeys.x];
        const y2 = d[datasetKeys.y];
        const rep = {
          x: x2,
          y: y2
        };
        if (datasetKeys.colorValue !== void 0) {
          rep.colorValue = d[datasetKeys.colorValue];
        }
        if (datasetKeys.sizeValue !== void 0) {
          rep.sizeValue = d[datasetKeys.sizeValue];
        }
        if (datasetKeys.z !== void 0) {
          rep.z = d[datasetKeys.z];
        }
        if (datasetKeys.id !== void 0) {
...
var getColor4 = (series, xAxis, yAxis, zAxis) => {
  ...
  if (zColorScale) {
    return (dataIndex) => {
      ...
      if (((_a2 = zAxis == null ? void 0 : zAxis.data) == null ? void 0 : _a2[dataIndex]) !== void 0) {
      ...
      const value = series.data[dataIndex];
      const color2 = zColorScale(value.colorValue ?? value.z);
      if (typeof color2 !== "string") {
        return getSeriesColor({
          value,
          dataIndex
  ...
  if (yColorScale) {
    return (dataIndex) => {
      ...
      const value = series.data[dataIndex];
      const color2 = yColorScale(value.y);
      if (typeof color2 !== "string") {
        return getSeriesColor({
          value,
          dataIndex
  ...
  if (xColorScale) {
    return (dataIndex) => {
      ...
      const value = series.data[dataIndex];
      const color2 = xColorScale(value.x);
      if (typeof color2 !== "string") {
        return getSeriesColor({
          value,
          dataIndex
...
var tooltipGetter4 = (params) => getLineLikeTooltip(params);
...
var selectorTooltipItemPosition7 = createSelectorMemoized(selectorChartsTooltipItem, selectorChartSeriesProcessed, selectorChartXAxis, selectorChartYAxis, function selectorTooltipItemPosition8(identifier, series, xAxes, yAxes) {
  var _a2, _b, _c;
  if (!identifier || identifier.type !== "scatter" || identifier.dataIndex === void 0) {
    return null;
  }
  const itemSeries = (_a2 = series.scatter) == null ? void 0 : _a2.series[identifier.seriesId];
  if (itemSeries == null) {
    return null;
  }
  const xAxis = xAxes.axis[itemSeries.xAxisId ?? xAxes.axisIds[0]];
...
var descriptionGetter4 = (params) => {
  ...
  const label = getLabel(series.label, "tooltip");
  const item = series.data[identifier.dataIndex];
  const formattedXValue = ((_a2 = xAxis.valueFormatter) == null ? void 0 : _a2.call(xAxis, item == null ? void 0 : item.x, {
    location: "tooltip",
    scale: xAxis.scale
  })) ?? "";
...
var scatterSeriesConfig = {
  ...
  selectorTooltipItemPosition: selectorTooltipItemPosition7,
...
function findClosestPoints(flatbush, seriesData, xScale, yScale, xZoomStart, xZoomEnd, yZoomStart, yZoomEnd, svgPointX, svgPointY, maxRadius = Infinity, maxResults = 1, getItemRadius = 0) {
  ...
  const pointX = originalXScale(invertScale(xScale, svgPointX, (dataIndex) => {
    var _a2;
    return (_a2 = seriesData[dataIndex]) == null ? void 0 : _a2.x;
  }));
  const pointY = originalYScale(invertScale(yScale, svgPointY, (dataIndex) => {
    var _a2;
    return (_a2 = seriesData[dataIndex]) == null ? void 0 : _a2.y;
  }));
  if (pointX === void 0 || pointY === void 0) {
    return [];
  }
  ...
  ranked.sort((a2, b) => a2.edge - b.edge);
  const splitIndex = ranked.findLastIndex((d) => d.edge < 0);
  if (splitIndex !== -1) {
    ranked = [...ranked.slice(0, splitIndex + 1).sort((a2, b) => a2.centerDistSq - b.centerDistSq), ...ranked.slice(splitIndex + 1)];
  }
...
var useChartClosestPoint = ({
  ...
  const {
    series,
    seriesOrder
  } = ((_a2 = store.use(selectorChartSeriesProcessed)) == null ? void 0 : _a2.scatter) ?? {};
  ...
  React72.useEffect(() => {
    ...
    const moveEndHandler = instance.addInteractionListener("moveEnd", (event) => {
      var _a3, _b, _c;
      if (!event.detail.activeGestures.pan) {
        (_a3 = instance.cleanInteraction) == null ? void 0 : _a3.call(instance);
...
// node_modules/@mui/x-charts/internals/plugins/featurePlugins/useProgressiveRendering/useProgressiveRendering.mjs
var React73 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/internals/plugins/featurePlugins/useProgressiveRendering/useProgressiveRendering.selectors.mjs
...
var selectorProgressivePlans = createSelector2(selectorProgressiveState, (s2) => s2 == null ? void 0 : s2.plans);
var selectorProgressiveRevealedRounds = createSelector2(selectorProgressiveState, (s2) => (s2 == null ? void 0 : s2.revealedRounds) ?? 0);
function getSeriesPointCount(processedSeries, seriesId) {
  ...
  for (const type in processedSeries) {
    ...
    const item = (_a2 = processedSeries[type]) == null ? void 0 : _a2.series[seriesId];
    if (item) {
...
var selectorProgressiveAggregate = createSelectorMemoized(selectorProgressivePlans, selectorChartSeriesProcessed, function selectorProgressiveAggregate2(plans, processedSeries) {
...
var selectorProgressiveBatchSize = createSelector2(selectorProgressiveAggregate, (a2) => a2.batchSize);
var selectorProgressiveTotalRounds = createSelector2(selectorProgressiveAggregate, (a2) => a2.totalRounds);
...
var selectorProgressiveSeriesRevealedBatches = createSelector2(selectorProgressiveAggregate, selectorProgressiveRevealedRounds, selectorChartZoomIsInteracting, function selectorProgressiveSeriesRevealedBatches2(agg, revealed, isInteracting, seriesId) {
...
var selectorShouldUseProgressiveRenderer = createSelector2(selectorChartSeriesProcessed, selectorProgressiveRenderingEnabled, (processedSeries, progressiveRenderingEnabled, seriesIds, renderer) => {
...
function sameSeriesIds(a2, b) {
  if (!a2 || a2.length !== b.length) {
    return false;
  }
...
var useProgressiveRendering = ({
  store
}) => {
  const registerProgressivePlan = useEventCallback_default((plotId, seriesIds, renderer) => {
  ...
  React73.useEffect(() => {
    ...
    if (revealed > 0) {
      resumeTimeout = setTimeout(() => {
        frame2 = requestAnimationFrame(step);
...
var DEFAULT_PLUGINS = [useChartZAxis, useChartBrush, useChartTooltip, useChartInteraction, useChartCartesianAxis, useChartHighlight, useChartVisibilityManager, useChartClosestPoint, useChartKeyboardNavigation, useProgressiveRendering];

// node_modules/@mui/x-charts/ChartsDataProvider/useChartsDataProviderProps.mjs
var _excluded33 = ["children", "localeText", "plugins", "slots", "slotProps", "seriesConfig"];
...
function ChartsDataProvider(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(ChartsProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime48.jsx)(ChartsLocalizationProvider, {
      localeText,
      children: (0, import_jsx_runtime48.jsx)(ChartsSlotsProvider, {
        slots,
        slotProps,
...
true ? ChartsDataProvider.propTypes = {
  ...
  apiRef: import_prop_types25.default.shape({
    current: import_prop_types25.default.any
  }),
  /**
   ...
   */
  experimentalFeatures: import_prop_types25.default.any,
  /**
   ...
   */
  series: import_prop_types25.default.arrayOf(import_prop_types25.default.object),
  /**
   * If `true`, animations are skipped.
  ...
  theme: import_prop_types25.default.oneOf(["dark", "light"]),
  /**
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime49.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime49.jsxs)(React75.Fragment, {
        children: [(0, import_jsx_runtime49.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime49.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime50.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime50.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime51.jsx)("linearGradient", _extends({
    id: gradientId
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime51.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime52.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime52.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime52.jsxs)(React76.Fragment, {
          children: [(0, import_jsx_runtime52.jsx)(ChartsContinuousGradient, {
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime52.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime52.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var ChartsSvgLayer = React77.forwardRef(function ChartsSvgLayer2(inProps, ref) {
  const {
    store
  } = useChartsContext();
  ...
  const {
    children,
    className
  } = themeProps, other = _objectWithoutPropertiesLoose(themeProps, _excluded34);
  const classes = useUtilityClasses16();
  const hasIntrinsicSize = svgHeight > 0 && svgWidth > 0;
  return (0, import_jsx_runtime53.jsxs)(ChartsSvgLayerStyles, _extends({
    viewBox: `0 0 ${svgWidth} ${svgHeight}`,
    className: clsx_default(classes.root, className)
  }, other, {
    ref,
    "aria-hidden": true,
    children: [(0, import_jsx_runtime53.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
function useRegisterPointerInteractions() {
  ...
  const chartsLayerContainerRef = useChartsLayerContainerRef();
  const store = useStore2();
  const interactionActive = React78.useRef(false);
  const lastItemRef = React78.useRef(void 0);
  React78.useEffect(() => {
    const element = chartsLayerContainerRef.current;
    if (!element) {
      return void 0;
    ...
    const onPointerMove = function onPointerMove2(event) {
      ...
      for (const seriesType of Object.keys(store.state.seriesConfig.config)) {
        item = (_b = (_a2 = store.state.seriesConfig.config[seriesType]).getItemAtPosition) == null ? void 0 : _b.call(_a2, store.state, {
          x: svgPoint.x,
          y: svgPoint.y
        });
        if (item) {
...
function useDescription() {
  ...
  const focusedSeries = (_a2 = seriesState[type]) == null ? void 0 : _a2.series[seriesId];
  if (!focusedSeries) {
    return null;
  }
...
function ChartsAccessibilityProxy() {
  ...
  const chartId = useChartId2();
  const currentFormatRef = React79.useRef(null);
  const currentIndexRef = React79.useRef(0);
...
var _excluded35 = ["children", "title", "desc", "className"];
...
var ChartsLayerContainer = React80.forwardRef(function ChartsLayerContainer2(inProps, ref) {
  const {
    store,
    instance
  } = useChartsContext();
  ...
  const {
    ...
    desc,
    className
  } = themeProps, other = _objectWithoutPropertiesLoose(themeProps, _excluded35);
  ...
  return (
    ...
    (0, import_jsx_runtime55.jsxs)(ChartsLayerContainerDiv, _extends({
      ref: handleRef,
      ownerState: {
        width: propsWidth,
        height: propsHeight
      ...
      onPointerEnter: (event) => {
        var _a2, _b;
        (_a2 = other.onPointerEnter) == null ? void 0 : _a2.call(other, event);
        (_b = instance.handlePointerEnter) == null ? void 0 : _b.call(instance, event);
      },
      onPointerLeave: (event) => {
        var _a2, _b;
        (_a2 = other.onPointerLeave) == null ? void 0 : _a2.call(other, event);
        (_b = instance.handlePointerLeave) == null ? void 0 : _b.call(instance, event);
      },
      onClick: (event) => {
        var _a2, _b;
        (_a2 = other.onClick) == null ? void 0 : _a2.call(other, event);
        (_b = instance.handleClick) == null ? void 0 : _b.call(instance, event);
      },
      children: [isKeyboardNavigationEnabled && (0, import_jsx_runtime55.jsx)(ChartsAccessibilityProxy, {}), desc && (0, import_jsx_runtime55.jsx)("span", {
        id: descId,
        style: {
          display: "none"
        },
...
var _excluded36 = ["children", "className", "title", "desc"];
var ChartsSurface = React81.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  const classes = useUtilityClasses15();
  return (0, import_jsx_runtime56.jsx)(ChartsLayerContainer, {
    className: clsx_default(classes.root, className),
    ref,
    title,
    desc,
    children: (0, import_jsx_runtime56.jsx)(ChartsSvgLayer, _extends({}, other, {
      children
    }))
  });
});
...
function useComponentRenderer(defaultElement, render, props, state = {}) {
  ...
  if (render) {
    ...
    return React82.cloneElement(render, props);
  }
  return React82.createElement(defaultElement, props);
}
...
var ToolbarContext = React83.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React83.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React83.useState(null);
  const focusableItemIdRef = React83.useRef(focusableItemId);
  const [items, setItems] = React83.useState([]);
  const getSortedItems = React83.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React83.useCallback((startIndex, step, wrap = true) => {
    var _a2, _b;
    ...
    for (let i = 0; i < itemCount; i += 1) {
      ...
      if (!((_a2 = sortedItems[index2].ref.current) == null ? void 0 : _a2.disabled) && ((_b = sortedItems[index2].ref.current) == null ? void 0 : _b.ariaDisabled) !== "true") {
        return index2;
      }
    }
    return -1;
  }, [getSortedItems]);
  const registerItem = React83.useCallback((id, itemRef) => {
    setItems((prevItems) => [...prevItems, {
      id,
      ref: itemRef
    }]);
  }, []);
  const unregisterItem = React83.useCallback((id) => {
    setItems((prevItems) => prevItems.filter((i) => i.id !== id));
  }, []);
  const onItemKeyDown = React83.useCallback((event) => {
    var _a2;
    if (!focusableItemId) {
      return;
    }
  ...
  const onItemFocus = React83.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React83.useCallback((id) => {
    var _a2;
    const sortedItems = getSortedItems();
  ...
  return (0, import_jsx_runtime57.jsx)(ToolbarContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React84.useRef(disabled);
  React84.useEffect(() => {
  ...
  const previousAriaDisabled = React84.useRef(ariaDisabled);
  React84.useEffect(() => {
...
var _excluded38 = ["className", "render"];
...
var Toolbar = React85.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
  ...
  return (0, import_jsx_runtime58.jsx)(ToolbarContextProvider, {
    children: element
  });
});
...
true ? Toolbar.propTypes = {
   ...
   */
  render: import_prop_types29.default.oneOfType([import_prop_types29.default.element, import_prop_types29.default.func])
} : void 0;
...
var _excluded39 = ["render", "onKeyDown", "onFocus", "disabled", "aria-disabled"];
var _excluded210 = ["tabIndex"];
var ToolbarButton = React86.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
  ...
  return (0, import_jsx_runtime59.jsx)(React86.Fragment, {
    children: element
  });
});
...
true ? ToolbarButton.propTypes = {
   ...
   */
  render: import_prop_types30.default.oneOfType([import_prop_types30.default.element, import_prop_types30.default.func]),
...
var _excluded40 = ["children", "sx", "extendVertically", "hideLegend", "legendDirection", "legendPosition"];
...
var Root3 = styled_default("div", {
  ...
  var _a2, _b;
  const gridTemplateColumns = getTemplateColumns(ownerState.hideLegend, ownerState.legendDirection, (_a2 = ownerState.legendPosition) == null ? void 0 : _a2.horizontal, width);
...
var ChartsWrapper = React87.forwardRef(function ChartsWrapper2(props, ref) {
  const {
    children,
    sx,
    extendVertically,
  ...
  const propsWidth = store.use(selectorChartPropsWidth);
  const propsHeight = store.use(selectorChartPropsHeight);
  const ownerState = React87.useMemo(() => ({
    hideLegend,
    legendDirection,
    legendPosition
  }), [hideLegend, legendDirection, legendPosition]);
  return (0, import_jsx_runtime60.jsx)(Root3, _extends({
    ref: handleRef,
    ownerState,
    sx,
...
true ? ChartsWrapper.propTypes = {
   ...
   */
  extendVertically: import_prop_types31.default.bool,
  /**
   * If `true`, the legend is not rendered.
   * @default false
   */
  hideLegend: import_prop_types31.default.bool,
  /**
   * The direction of the legend.
   * @default 'horizontal'
   */
  legendDirection: import_prop_types31.default.oneOf(["horizontal", "vertical"]),
  /**
   * The position of the legend.
   * @default { horizontal: 'center', vertical: 'bottom' }
   */
  legendPosition: import_prop_types31.default.shape({
    horizontal: import_prop_types31.default.oneOf(["center", "end", "start"]),
    vertical: import_prop_types31.default.oneOf(["bottom", "middle", "top"])
  }),
  sx: import_prop_types31.default.oneOfType([import_prop_types31.default.arrayOf(import_prop_types31.default.oneOfType([import_prop_types31.default.func, import_prop_types31.default.object, import_prop_types31.default.bool])), import_prop_types31.default.func, import_prop_types31.default.object])
} : void 0;

// node_modules/@mui/x-charts/BarChart/FocusedBar.mjs
...
function FocusedBar(props) {
  ...
  const groupIndex = barSeries.stackingGroups.findIndex((group2) => group2.ids.includes(focusedItem.seriesId));
  ...
  return (0, import_jsx_runtime61.jsx)("rect", _extends({
    fill: "none",
    stroke: (theme.vars ?? theme).palette.text.primary,
    strokeWidth: 2,
    x: x2 - 3,
...
var BarChart = React89.forwardRef(function BarChart2(inProps, ref) {
  var _a2, _b, _c, _d;
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  ...
  const Tooltip = ((_a2 = props.slots) == null ? void 0 : _a2.tooltip) ?? ChartsTooltip;
  const Toolbar3 = (_b = props.slots) == null ? void 0 : _b.toolbar;
  return (0, import_jsx_runtime62.jsx)(ChartsDataProvider, _extends({}, chartsDataProviderProps, {
    children: (0, import_jsx_runtime62.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      ref,
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime62.jsx)(Toolbar3, _extends({}, (_c = props.slotProps) == null ? void 0 : _c.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime62.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime62.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime62.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime62.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime62.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime62.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime62.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), (0, import_jsx_runtime62.jsx)(FocusedBar, {})]
        })), (0, import_jsx_runtime62.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime62.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime62.jsx)(Tooltip, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.tooltip))]
    }))
  }));
});
...
true ? BarChart.propTypes = {
   ...
   * @default 0
   */
  axesGap: import_prop_types32.default.number,
  /**
   ...
   * Defines the border radius of the bar element.
   */
  borderRadius: import_prop_types32.default.number,
  /**
   * Configuration for the brush interaction.
   */
  brushConfig: import_prop_types32.default.shape({
    enabled: import_prop_types32.default.bool,
    preventHighlight: import_prop_types32.default.bool,
    preventTooltip: import_prop_types32.default.bool
  }),
   ...
   */
  disableKeyboardNavigation: import_prop_types32.default.bool,
  /**
   * Options to enable features planned for the next major.
   */
  experimentalFeatures: import_prop_types32.default.object,
  /**
   ...
   * ```
   */
  hiddenItems: import_prop_types32.default.arrayOf(import_prop_types32.default.oneOfType([import_prop_types32.default.shape({
    dataIndex: import_prop_types32.default.number,
    seriesId: import_prop_types32.default.string.isRequired,
    type: import_prop_types32.default.oneOf(["bar"]).isRequired
  }), import_prop_types32.default.shape({
    dataIndex: import_prop_types32.default.number,
    seriesId: import_prop_types32.default.string.isRequired,
    type: import_prop_types32.default.oneOf(["bar"])
  })]).isRequired),
  /**
   * If `true`, the legend is not rendered.
   */
   ...
   */
  highlightedAxis: import_prop_types32.default.arrayOf(import_prop_types32.default.shape({
    axisId: import_prop_types32.default.oneOfType([import_prop_types32.default.number, import_prop_types32.default.string]).isRequired,
   ...
   */
  highlightedItem: import_prop_types32.default.oneOfType([import_prop_types32.default.shape({
    dataIndex: import_prop_types32.default.number,
    seriesId: import_prop_types32.default.string.isRequired
  }), import_prop_types32.default.shape({
    dataIndex: import_prop_types32.default.number,
   ...
   * ```
   */
  initialHiddenItems: import_prop_types32.default.arrayOf(import_prop_types32.default.oneOfType([import_prop_types32.default.shape({
    dataIndex: import_prop_types32.default.number,
    seriesId: import_prop_types32.default.string.isRequired,
    type: import_prop_types32.default.oneOf(["bar"]).isRequired
  }), import_prop_types32.default.shape({
   ...
   * @default 'vertical'
   */
  layout: import_prop_types32.default.oneOf(["horizontal", "vertical"]),
  /**
   ...
   */
  onHiddenItemsChange: import_prop_types32.default.func,
  /**
   ...
   */
  onHighlightedAxisChange: import_prop_types32.default.func,
  /**
   * Callback fired when a bar item is clicked.
   * @param {MouseEvent | React.MouseEvent<SVGElement, MouseEvent>} event The event source of the callback.
   *        It is a native MouseEvent for `svg-batch` renderer and a React MouseEvent for `svg-single` renderer.
   ...
   * @param {AxisItemIdentifier[]} axisItems The array of axes item identifiers.
   */
  onTooltipAxisChange: import_prop_types32.default.func,
  /**
   * The callback fired when the tooltip item changes.
   *
   * @param {SeriesItemIdentifier<SeriesType> | null} tooltipItem  The newly highlighted item.
   */
  onTooltipItemChange: import_prop_types32.default.func,
  /**
   * The type of renderer to use for the bar plot.
   * - `svg-single`: Renders every bar in a `<rect />` element.
   * - `svg-batch`: Batch renders bars in `<path />` elements for better performance with large datasets, at the cost of some limitations.
   ...
   * @default 'svg-single'
   */
  renderer: import_prop_types32.default.oneOf(["svg-batch", "svg-single"]),
  /**
   ...
   * Identified by the axis id, and data index.
   */
  tooltipAxis: import_prop_types32.default.arrayOf(import_prop_types32.default.shape({
    axisId: import_prop_types32.default.oneOfType([import_prop_types32.default.number, import_prop_types32.default.string]).isRequired,
    dataIndex: import_prop_types32.default.number.isRequired
  })),
  /**
   ...
   */
  tooltipItem: import_prop_types32.default.oneOfType([import_prop_types32.default.shape({
    dataIndex: import_prop_types32.default.number.isRequired,
    seriesId: import_prop_types32.default.string.isRequired
  }), import_prop_types32.default.shape({
    dataIndex: import_prop_types32.default.number.isRequired,
   ...
   */
  xAxis: import_prop_types32.default.arrayOf(import_prop_types32.default.object),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types32.default.arrayOf(import_prop_types32.default.object)
} : void 0;
export {
  BAR_CHART_PLUGINS,
  BarChart,
