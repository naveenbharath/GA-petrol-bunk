...
var PopperTooltip = React5.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const resolvedAnchorElement = React5.useMemo(() => resolveAnchorEl(anchorEl), [anchorEl]);
  React5.useEffect(() => {
...
// node_modules/@mui/material/transitions/useReducedMotion.mjs
...
function useReducedMotionMediaQueryOld(enabled) {
  const [queryState, setQueryState] = React8.useState(() => ({
    enabled,
...
//# sourceMappingURL=chunk-5WCQRXU7.js.map
