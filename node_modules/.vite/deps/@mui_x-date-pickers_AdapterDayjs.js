...
// node_modules/@mui/x-date-pickers/AdapterDayjs/AdapterDayjs.mjs
...
function throwMissingUTCPluginError() {
  throw new Error(true ? "MUI X Date Pickers: Missing dayjs UTC plugin. UTC and timezone support requires the dayjs UTC plugin to be enabled. See https://mui.com/x/react-date-pickers/timezone/#day-js-and-utc for setup instructions." : formatErrorMessage(138));
}
function throwMissingTimezonePluginError() {
  throw new Error(true ? "MUI X Date Pickers: Missing dayjs timezone plugin. Timezone support requires both the dayjs UTC and timezone plugins to be enabled. See https://mui.com/x/react-date-pickers/timezone/#day-js-and-timezone for setup instructions." : formatErrorMessage(139));
}
var AdapterDayjs = class {
  constructor({
    ...
    __publicField(this, "formatTokenMap", formatTokenMap);
    ...
    __publicField(this, "createSystemDate", (value) => {
      return this.setLocaleToValue((0, import_dayjs.default)(value));
    });
