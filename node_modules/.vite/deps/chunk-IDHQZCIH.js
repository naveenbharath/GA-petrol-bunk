...
// node_modules/@mui/x-date-pickers/LocalizationProvider/LocalizationProvider.mjs
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  const adapter = React.useMemo(() => {
    ...
    if (!dateAdapter.isMUIAdapter) {
      throw new Error(true ? "MUI X Date Pickers: The date adapter should be imported from `@mui/x-date-pickers` or `@mui/x-date-pickers-pro`, not from `@date-io`. Using adapters from @date-io directly is not supported. For example, use `import { AdapterDayjs } from '@mui/x-date-pickers/AdapterDayjs'` instead of `import AdapterDayjs from '@date-io/dayjs'`. See https://mui.com/x/react-date-pickers/quickstart/#installation" : formatErrorMessage(143));
    }
    return dateAdapter;
...
//# sourceMappingURL=chunk-IDHQZCIH.js.map
